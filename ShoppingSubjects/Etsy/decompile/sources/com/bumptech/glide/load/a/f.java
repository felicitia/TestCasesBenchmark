...
public class f implements c<InputStream> {
    ...
    private InputStream a(URL url, int i, URL url2, Map<String, String> map) throws IOException {
        ...
        if (i2 == 3) {
            String headerField = this.d.getHeaderField(Includes.LOCATION);
    ...
    private InputStream a(HttpURLConnection httpURLConnection) throws IOException {
        if (TextUtils.isEmpty(httpURLConnection.getContentEncoding())) {
            this.e = com.bumptech.glide.g.b.a(httpURLConnection.getInputStream(), (long) httpURLConnection.getContentLength());
        } else {
