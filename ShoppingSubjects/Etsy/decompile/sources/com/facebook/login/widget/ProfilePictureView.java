...
public class ProfilePictureView extends FrameLayout {
    ...
    public final void setProfileId(@Nullable String str) {
        boolean z;
        if (z.a(this.profileId) || !this.profileId.equalsIgnoreCase(str)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i) != 1073741824 && layoutParams.width == -2) {
            ...
            i = MeasureSpec.makeMeasureSpec(size2, ErrorDialogData.SUPPRESSED);
            z = true;
        }
        if (z) {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, g.com_facebook_profile_picture_view);
        setPresetSize(obtainStyledAttributes.getInt(g.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = obtainStyledAttributes.getBoolean(g.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        if (this.lastRequest != null) {
            n.b(this.lastRequest);
        }
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? b.com_facebook_profile_picture_blank_square : b.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private void sendImageRequest(boolean z) {
        o a2 = new com.facebook.internal.o.a(getContext(), o.a(this.profileId, this.queryWidth, this.queryHeight)).a(z).a((Object) this).a((o.b) new o.b() {
            public void a(p pVar) {
                ProfilePictureView.this.processResponse(pVar);
            }
        }).a();
        if (this.lastRequest != null) {
            n.b(this.lastRequest);
        ...
        if (pVar.a() == this.lastRequest) {
            ...
            if (b != null) {
                ...
                if (aVar != null) {
                    ...
                    aVar.a(new FacebookException(sb.toString(), (Throwable) b));
                    return;
                }
                t.a(LoggingBehavior.REQUESTS, 6, TAG, b.toString());
            } else if (c != null) {
                setImageBitmap(c);
                if (pVar.d()) {
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                i = com.facebook.login.f.a.com_facebook_profilepictureview_preset_size_large;
                break;
            case -3:
                i = com.facebook.login.f.a.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                i = com.facebook.login.f.a.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (z) {
                    i = com.facebook.login.f.a.com_facebook_profilepictureview_preset_size_normal;
