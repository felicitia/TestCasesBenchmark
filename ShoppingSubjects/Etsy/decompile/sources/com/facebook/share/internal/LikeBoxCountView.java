...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(b.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(b.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(b.com_facebook_likeboxcountview_border_radius);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(C0120a.com_facebook_likeboxcountview_border_color));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(b.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(C0120a.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(b.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(b.com_facebook_likeboxcountview_caret_height);
    }
