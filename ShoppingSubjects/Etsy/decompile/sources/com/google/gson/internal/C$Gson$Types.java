...
public final class C$Gson$Types {
    ...
    private static final class GenericArrayTypeImpl implements Serializable, GenericArrayType {
        ...
        public String toString() {
            ...
            sb.append(C$Gson$Types.f(this.componentType));
            sb.append("[]");
            return sb.toString();
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                C$Gson$Types.h(this.typeArguments[i]);
        ...
        public String toString() {
            ...
            sb.append("<");
            sb.append(C$Gson$Types.f(this.typeArguments[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ");
                sb.append(C$Gson$Types.f(this.typeArguments[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class WildcardTypeImpl implements Serializable, WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder sb = new StringBuilder();
                sb.append("? super ");
                sb.append(C$Gson$Types.f(this.lowerBound));
                return sb.toString();
                ...
                sb2.append("? extends ");
                sb2.append(C$Gson$Types.f(this.upperBound));
                return sb2.toString();
            }
        }
    }
    ...
    public static java.lang.reflect.Type d(java.lang.reflect.Type r3) {
        ...
        L_0x0059:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.C$Gson$Types.d(java.lang.reflect.Type):java.lang.reflect.Type");
    }
