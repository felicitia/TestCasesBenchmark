...
final class al implements ServiceConnection {
    ...
    private al(aj ajVar) {
        this.f = ajVar;
        this.a = 0;
        this.b = new Messenger(new Handler(Looper.getMainLooper(), new am(this)));
        this.d = new ArrayDeque();
        this.e = new SparseArray<>();
    }

    private final void c() {
        this.f.c.execute(new b(this));
    }
    ...
    public final synchronized void a(int i) {
        ...
        if (eVar != null) {
            ...
            this.e.remove(i);
            eVar.a(new zzaf(3, "Timed out waiting for response"));
            a();
        }
    }
    ...
    /* JADX INFO: used method not loaded: com.google.firebase.iid.e.a(com.google.firebase.iid.zzaf):null, types can be incorrect */
    /* JADX INFO: used method not loaded: com.google.firebase.iid.e.a(android.os.Bundle):null, types can be incorrect */
    /* access modifiers changed from: 0000 */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x005f, code lost:
        r1.a(new com.google.firebase.iid.zzaf(4, "Not supported by GmsCore"));
     */
    ...
    public final boolean a(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.firebase.iid.e<?>> r1 = r4.e     // Catch:{ all -> 0x006f }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ all -> 0x006f }
            com.google.firebase.iid.e r1 = (com.google.firebase.iid.e) r1     // Catch:{ all -> 0x006f }
            r2 = 1
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.firebase.iid.e<?>> r3 = r4.e     // Catch:{ all -> 0x006f }
        ...
        L_0x006f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.al.a(android.os.Message):boolean");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean a(com.google.firebase.iid.e r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x000b:
            ...
            return r1
        L_0x000d:
            java.util.Queue<com.google.firebase.iid.e<?>> r0 = r5.d     // Catch:{ all -> 0x008e }
        ...
        L_0x003d:
            ...
            com.google.firebase.iid.aj r3 = r5.f     // Catch:{ all -> 0x008e }
            android.content.Context r3 = r3.b     // Catch:{ all -> 0x008e }
            ...
            goto L_0x0073
        L_0x0061:
            com.google.firebase.iid.aj r6 = r5.f     // Catch:{ all -> 0x008e }
            java.util.concurrent.ScheduledExecutorService r6 = r6.c     // Catch:{ all -> 0x008e }
            com.google.firebase.iid.an r0 = new com.google.firebase.iid.an     // Catch:{ all -> 0x008e }
        ...
        L_0x008e:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.al.a(com.google.firebase.iid.e):boolean");
    }
