    ...
    public static abstract class Stub extends zzb implements ISignInButtonCreator {
        ...
        public static class Proxy extends zza implements ISignInButtonCreator {
            ...
            public IObjectWrapper newSignInButtonFromConfig(IObjectWrapper iObjectWrapper, SignInButtonConfig signInButtonConfig) throws RemoteException {
                Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                a.a(obtainAndWriteInterfaceToken, (IInterface) iObjectWrapper);
                a.a(obtainAndWriteInterfaceToken, (Parcelable) signInButtonConfig);
        ...
        public boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    break;
                case 2:
                    iObjectWrapper = newSignInButtonFromConfig(com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), (SignInButtonConfig) a.a(parcel, SignInButtonConfig.CREATOR));
                    break;
                default:
                    return false;
            }
