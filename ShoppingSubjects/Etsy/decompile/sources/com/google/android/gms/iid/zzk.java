...
public final class zzk implements ServiceConnection {
    ...
    private final synchronized void zzl() {
        ...
        L_0x0011:
            java.util.Queue<com.google.android.gms.iid.n> r0 = r5.zzbn     // Catch:{ all -> 0x00b5 }
        ...
        L_0x0043:
            ...
            com.google.android.gms.iid.n r0 = (com.google.android.gms.iid.n) r0     // Catch:{ all -> 0x00b5 }
            com.google.android.gms.iid.zzi r2 = r5.zzbo     // Catch:{ all -> 0x00b5 }
            r2.zzd(r0)     // Catch:{ all -> 0x00b5 }
            goto L_0x0011
        L_0x0051:
            java.lang.String r0 = "EnhancedIntentService"
            boolean r0 = android.util.Log.isLoggable(r0, r1)     // Catch:{ all -> 0x00b5 }
    ...
    public final synchronized void zzd(Intent intent, PendingResult pendingResult) {
        ...
        this.zzbn.add(new n(intent, pendingResult, this.zzbm));
        zzl();
    }
}
