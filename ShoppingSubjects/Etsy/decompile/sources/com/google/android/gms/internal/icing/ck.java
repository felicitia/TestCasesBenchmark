...
final class ck implements Comparable<ck>, Entry<K, V> {
    private final K a;
    private V b;
    ...
    ck(cd cdVar, Entry<K, V> entry) {
        this(cdVar, (Comparable) entry.getKey(), entry.getValue());
    }
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        return ((Comparable) getKey()).compareTo((Comparable) ((ck) obj).getKey());
    }
