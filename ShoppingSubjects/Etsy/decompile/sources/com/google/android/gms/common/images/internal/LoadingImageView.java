...
import com.google.android.gms.b.a.d;
...
public final class LoadingImageView extends ImageView {
    ...
    public LoadingImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzqs = obtainStyledAttributes.getInt(d.LoadingImageView_imageAspectRatioAdjust, 0);
        this.zzqt = obtainStyledAttributes.getFloat(d.LoadingImageView_imageAspectRatio, 1.0f);
    ...
    public final void loadUri(Uri uri, int i, boolean z, boolean z2) {
        boolean z3 = true;
        boolean z4 = uri != null ? uri.equals(this.zzqn) : this.zzqn == null;
        if (z4) {
            if (this.zzqn != null) {
                zzc(true);
                return;
