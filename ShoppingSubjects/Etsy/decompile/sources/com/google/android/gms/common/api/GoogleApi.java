...
public class GoogleApi<O extends ApiOptions> {
    ...
    private final <TResult, A extends AnyClient> f<TResult> zza(int i, @NonNull TaskApiCall<A, TResult> taskApiCall) {
        g gVar = new g();
        this.zzcq.zza(this, i, taskApiCall, gVar, this.zzcp);
        return gVar.a();
    }
    ...
    @KeepForSdk
    public <TResult, A extends AnyClient> f<TResult> doBestEffortWrite(TaskApiCall<A, TResult> taskApiCall) {
    ...
    @KeepForSdk
    public <TResult, A extends AnyClient> f<TResult> doRead(TaskApiCall<A, TResult> taskApiCall) {
        return zza(0, taskApiCall);
    }

    @KeepForSdk
    public <A extends AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> f<Void> doRegisterEventListener(@NonNull T t, U u) {
    ...
    @KeepForSdk
    public f<Boolean> doUnregisterEventListener(@NonNull ListenerKey<?> listenerKey) {
    ...
    @KeepForSdk
    public <TResult, A extends AnyClient> f<TResult> doWrite(TaskApiCall<A, TResult> taskApiCall) {
