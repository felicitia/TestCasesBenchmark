...
interface aai {
    ...
    <K, V> void a(int i, ye<K, V> yeVar, Map<K, V> map) throws IOException;

    void a(int i, zzbah zzbah) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, zd zdVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, zd zdVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, zd zdVar) throws IOException;

    void b(int i, List<zzbah> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, zd zdVar) throws IOException;
