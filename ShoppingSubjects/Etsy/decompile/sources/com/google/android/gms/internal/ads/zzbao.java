...
class zzbao extends zzban {
    ...
    public final void zza(wf wfVar) throws IOException {
        wfVar.a(this.zzdpw, zzabh(), size());
    }
    ...
    public final boolean zzabe() {
        int zzabh = zzabh();
        return aad.a(this.zzdpw, zzabh, size() + zzabh);
    }

    public final wl zzabf() {
        return wl.a(this.zzdpw, zzabh(), size(), true);
    }
    ...
    public final int zzc(int i, int i2, int i3) {
        return xj.a(i, this.zzdpw, zzabh(), i3);
    }
