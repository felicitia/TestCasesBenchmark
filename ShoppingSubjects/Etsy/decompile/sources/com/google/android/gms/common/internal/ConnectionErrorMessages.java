...
public final class ConnectionErrorMessages {
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                i2 = c.common_google_play_services_install_button;
                break;
            case 2:
                i2 = c.common_google_play_services_update_button;
                break;
            case 3:
                i2 = c.common_google_play_services_enable_button;
                break;
            default:
                i2 = 17039370;
                break;
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 9) {
            return resources.getString(c.common_google_play_services_unsupported_text, new Object[]{appName});
        } else if (i == 20) {
            return zza(context, "common_google_play_services_restricted_profile_text", appName);
        } else {
            switch (i) {
                case 1:
                    return resources.getString(c.common_google_play_services_install_text, new Object[]{appName});
                case 2:
                    if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                        return resources.getString(c.common_google_play_services_wear_update_text);
                    }
                    return resources.getString(c.common_google_play_services_update_text, new Object[]{appName});
                case 3:
                    return resources.getString(c.common_google_play_services_enable_text, new Object[]{appName});
                default:
                    switch (i) {
                        case 16:
                        ...
                        case 18:
                            return resources.getString(c.common_google_play_services_updating_text, new Object[]{appName});
                        default:
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return zzb == null ? context.getResources().getString(c.common_google_play_services_notification_ticker) : zzb;
    }
    ...
    public static java.lang.String getErrorTitle(android.content.Context r3, int r4) {
        ...
        L_0x006b:
            return r1
        L_0x006c:
            int r3 = com.google.android.gms.b.a.c.common_google_play_services_enable_title
            java.lang.String r3 = r0.getString(r3)
            return r3
        L_0x0073:
            int r3 = com.google.android.gms.b.a.c.common_google_play_services_update_title
            java.lang.String r3 = r0.getString(r3)
            return r3
        L_0x007a:
            int r3 = com.google.android.gms.b.a.c.common_google_play_services_install_title
            java.lang.String r3 = r0.getString(r3)
            return r3
        L_0x0081:
            java.lang.String r4 = "GoogleApiAvailability"
