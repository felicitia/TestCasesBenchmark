...
interface df {
    ...
    <K, V> void a(int i, bf<K, V> bfVar, Map<K, V> map) throws IOException;

    void a(int i, zzbi zzbi) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, ca caVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, ca caVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, ca caVar) throws IOException;

    void b(int i, List<zzbi> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, ca caVar) throws IOException;
