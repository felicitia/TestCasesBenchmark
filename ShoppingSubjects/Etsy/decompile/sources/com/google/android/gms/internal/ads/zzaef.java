...
public final class zzaef extends AbstractSafeParcelable {
    ...
    @Constructor
    zzaef(@Param(id = 1) int i, @Param(id = 2) Bundle bundle, @Param(id = 3) zzjj zzjj, @Param(id = 4) zzjn zzjn, @Param(id = 5) String str, @Param(id = 6) ApplicationInfo applicationInfo2, @Param(id = 7) PackageInfo packageInfo, @Param(id = 8) String str2, @Param(id = 9) String str3, @Param(id = 10) String str4, @Param(id = 11) zzang zzang, @Param(id = 12) Bundle bundle2, @Param(id = 13) int i2, @Param(id = 14) List<String> list, @Param(id = 15) Bundle bundle3, @Param(id = 16) boolean z, @Param(id = 18) int i3, @Param(id = 19) int i4, @Param(id = 20) float f, @Param(id = 21) String str5, @Param(id = 25) long j, @Param(id = 26) String str6, @Param(id = 27) List<String> list2, @Param(id = 28) String str7, @Param(id = 29) zzpl zzpl, @Param(id = 30) List<String> list3, @Param(id = 31) long j2, @Param(id = 33) String str8, @Param(id = 34) float f2, @Param(id = 40) boolean z2, @Param(id = 35) int i5, @Param(id = 36) int i6, @Param(id = 37) boolean z3, @Param(id = 38) boolean z4, @Param(id = 39) String str9, @Param(id = 41) String str10, @Param(id = 42) boolean z5, @Param(id = 43) int i7, @Param(id = 44) Bundle bundle4, @Param(id = 45) String str11, @Param(id = 46) zzlu zzlu, @Param(id = 47) boolean z6, @Param(id = 48) Bundle bundle5, @Param(id = 49) String str12, @Param(id = 50) String str13, @Param(id = 51) String str14, @Param(id = 52) boolean z7, @Param(id = 53) List<Integer> list4, @Param(id = 54) String str15, @Param(id = 55) List<String> list5, @Param(id = 56) int i8, @Param(id = 57) boolean z8, @Param(id = 58) boolean z9, @Param(id = 59) boolean z10, @Param(id = 60) ArrayList<String> arrayList) {
        this.versionCode = i;
        this.zzccu = bundle;
        this.zzccv = zzjj;
        this.zzacv = zzjn;
    ...
    public zzaef(cr crVar, long j, String str, String str2, String str3) {
        cr crVar2 = crVar;
        Bundle bundle = crVar2.a;
        zzjj zzjj = crVar2.b;
        zzjn zzjn = crVar2.c;
        String str4 = crVar2.d;
        ApplicationInfo applicationInfo2 = crVar2.e;
        PackageInfo packageInfo = crVar2.f;
        String str5 = (String) ki.a(crVar2.Q, "");
        String str6 = crVar2.g;
        String str7 = crVar2.h;
        zzang zzang = crVar2.j;
        Bundle bundle2 = crVar2.i;
        int i = crVar2.k;
        List<String> list = crVar2.l;
        List<String> list2 = crVar2.m;
        Bundle bundle3 = crVar2.o;
        boolean z = crVar2.p;
        int i2 = crVar2.q;
        int i3 = crVar2.r;
        float f = crVar2.s;
        List<String> list3 = list2;
        String str8 = crVar2.t;
        long j2 = crVar2.u;
        String str9 = crVar2.v;
        List<String> list4 = crVar2.w;
        String str10 = str9;
        String str11 = crVar2.x;
        zzpl zzpl = crVar2.y;
        String str12 = crVar2.z;
        float f2 = crVar2.A;
        boolean z2 = crVar2.B;
        int i4 = crVar2.C;
        int i5 = crVar2.D;
        ...
        int i6 = i;
        String str13 = (String) ki.a(crVar2.G, "", 1, TimeUnit.SECONDS);
        String str14 = crVar2.H;
        boolean z5 = crVar2.I;
        int i7 = crVar2.J;
        Bundle bundle5 = crVar2.K;
        String str15 = crVar2.L;
        String str16 = str14;
        zzlu zzlu = crVar2.M;
        boolean z6 = crVar2.N;
        Bundle bundle6 = crVar2.O;
        boolean z7 = crVar2.P;
        List<Integer> list7 = crVar2.R;
        String str17 = crVar2.S;
        List<String> list8 = crVar2.n;
        int i8 = crVar2.T;
        boolean z8 = crVar2.U;
        boolean z9 = crVar2.V;
        boolean z10 = crVar2.W;
        ArrayList<String> arrayList = crVar2.X;
        ...
        long j3 = j;
        this(bundle, zzjj, zzjn, str4, applicationInfo2, packageInfo, str5, str6, str7, zzang, bundle4, i6, list6, list9, bundle8, z13, i10, i11, f3, str18, j2, str19, list5, str11, zzpl, j3, str12, f2, z2, i4, i5, z3, z4, str13, str16, z11, i9, bundle7, str15, zzlu, z6, bundle6, str, str2, str3, z7, list7, str17, list8, i8, z8, z9, z12, arrayList);
    }
