...
public final class zzav extends GoogleApiClient implements zzbq {
    ...
    public zzav(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, AbstractClientBuilder<? extends b, c> abstractClientBuilder, Map<Api<?>, Boolean> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<AnyClientKey<?>, Client> map2, int i, int i2, ArrayList<zzp> arrayList, boolean z) {
    ...
    private final void zzg(int i) {
        if (this.zzip == null) {
            ...
            StringBuilder sb = new StringBuilder(51 + String.valueOf(zzh).length() + String.valueOf(zzh2).length());
