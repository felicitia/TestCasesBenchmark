...
final class GoogleCertificates {
    ...
    private static void zzc() throws LoadingException {
        if (zzax == null) {
            ...
            synchronized (zzay) {
                if (zzax == null) {
                    zzax = IGoogleCertificatesApi.Stub.asInterface(DynamiteModule.a(zzaz, DynamiteModule.d, "com.google.android.gms.googlecertificates").a("com.google.android.gms.common.GoogleCertificatesImpl"));
                }
            }
        }
    }
