...
public final class zze {
    ...
    public static class zza implements BaseColumns {
        private static HashMap<Uri, d> zzagq = new HashMap<>();

        private static d zza(ContentResolver contentResolver, Uri uri) {
            d dVar = (d) zzagq.get(uri);
            if (dVar == null) {
                d dVar2 = new d();
                zzagq.put(uri, dVar2);
                contentResolver.registerContentObserver(uri, true, new c(null, dVar2));
                return dVar2;
            } else if (!dVar.c.getAndSet(false)) {
                return dVar;
            } else {
                synchronized (dVar) {
                    dVar.a.clear();
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:?, code lost:
            r4 = r11;
            r5 = r12;
            r11 = r4.query(r5, new java.lang.String[]{com.etsy.android.lib.models.ResponseConstants.VALUE}, "name=?", new java.lang.String[]{r13}, null);
         */
        ...
        protected static java.lang.String zza(android.content.ContentResolver r11, android.net.Uri r12, java.lang.String r13) {
            /*
                ...
                monitor-enter(r0)
                com.google.android.gms.internal.stable.d r1 = zza(r11, r12)     // Catch:{ all -> 0x008a }
                monitor-exit(r0)     // Catch:{ all -> 0x008a }
                monitor-enter(r1)
                java.lang.Object r0 = r1.b     // Catch:{ all -> 0x0087 }
                java.util.HashMap<java.lang.String, java.lang.String> r2 = r1.a     // Catch:{ all -> 0x0087 }
                boolean r2 = r2.containsKey(r13)     // Catch:{ all -> 0x0087 }
                if (r2 == 0) goto L_0x001d
                java.util.HashMap<java.lang.String, java.lang.String> r11 = r1.a     // Catch:{ all -> 0x0087 }
        ...
        private static void zza(d dVar, Object obj, String str, String str2) {
            synchronized (dVar) {
                if (obj == dVar.b) {
                    dVar.a.put(str, str2);
                }
