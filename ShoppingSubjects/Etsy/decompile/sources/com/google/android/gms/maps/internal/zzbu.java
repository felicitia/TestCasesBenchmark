...
public final class zzbu extends zza implements IStreetViewPanoramaDelegate {
    ...
    public final void animateTo(StreetViewPanoramaCamera streetViewPanoramaCamera, long j) throws RemoteException {
        ...
        a.a(obtainAndWriteInterfaceToken, (Parcelable) streetViewPanoramaCamera);
    ...
    public final StreetViewPanoramaCamera getPanoramaCamera() throws RemoteException {
        ...
        StreetViewPanoramaCamera streetViewPanoramaCamera = (StreetViewPanoramaCamera) a.a(transactAndReadException, StreetViewPanoramaCamera.CREATOR);
    ...
    public final StreetViewPanoramaLocation getStreetViewPanoramaLocation() throws RemoteException {
        ...
        StreetViewPanoramaLocation streetViewPanoramaLocation = (StreetViewPanoramaLocation) a.a(transactAndReadException, StreetViewPanoramaLocation.CREATOR);
        transactAndReadException.recycle();
    ...
    public final IObjectWrapper orientationToPoint(StreetViewPanoramaOrientation streetViewPanoramaOrientation) throws RemoteException {
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        a.a(obtainAndWriteInterfaceToken, (Parcelable) streetViewPanoramaOrientation);
    ...
    public final StreetViewPanoramaOrientation pointToOrientation(IObjectWrapper iObjectWrapper) throws RemoteException {
        ...
        StreetViewPanoramaOrientation streetViewPanoramaOrientation = (StreetViewPanoramaOrientation) a.a(transactAndReadException, StreetViewPanoramaOrientation.CREATOR);
        transactAndReadException.recycle();
    ...
    public final void setPositionWithRadiusAndSource(LatLng latLng, int i, StreetViewSource streetViewSource) throws RemoteException {
        ...
        a.a(obtainAndWriteInterfaceToken, (Parcelable) latLng);
        obtainAndWriteInterfaceToken.writeInt(i);
        a.a(obtainAndWriteInterfaceToken, (Parcelable) streetViewSource);
