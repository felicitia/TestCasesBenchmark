...
public class zzasv extends zzass {
    ...
    public synchronized void destroy() {
        if (!this.zzdfh) {
            ...
            try {
                ...
                ao.i().a((Throwable) e, "AdWebViewImpl.loadUrlUnsafe");
    ...
    public synchronized void evaluateJavascript(java.lang.String r2, android.webkit.ValueCallback<java.lang.String> r3) {
        /*
            ...
            com.google.android.gms.internal.ads.gv.e(r2)     // Catch:{ all -> 0x0019 }
    ...
    public final synchronized void zzc(pe peVar) {
        if (isDestroyed()) {
            gv.a("Blank page loaded, 1...");
            zzuk();
            return;
        }
        super.zzc(peVar);
