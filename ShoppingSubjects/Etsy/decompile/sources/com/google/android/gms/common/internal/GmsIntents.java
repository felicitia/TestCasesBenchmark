...
public class GmsIntents {
    ...
    public static Intent createPlayStoreLightPurchaseFlowIntent(Context context, @Nullable String str, String str2) {
        ...
        intent2.setData(Uri.parse(String.format(Locale.US, "https://play.google.com/store/apps/details?id=%1$s&rdid=%1$s&rdot=%2$d", new Object[]{str2, Integer.valueOf(1)})));
    ...
    public static void sendIcingContactChangedBroadcast(Context context, boolean z) {
        ...
        if (Log.isLoggable("GmsIntents", 2)) {
            ...
            StringBuilder sb = new StringBuilder(98 + String.valueOf(action).length());
    ...
    private static void zza(String str, Context context, String str2, int[] iArr) {
        ...
        if (Log.isLoggable("GmsIntents", 3)) {
            String action = putExtra.getAction();
            StringBuilder sb = new StringBuilder(72 + String.valueOf(str).length() + String.valueOf(action).length());
