...
public final class zzaiq extends AbstractSafeParcelable {
    ...
    public static zzaiq zzo(JSONObject jSONObject) throws JSONException {
        ...
        zzaiq zzaiq = new zzaiq(jSONObject.optString("click_string", ""), jSONObject.optString("report_url", ""), jSONObject.optBoolean("rendered_ad_enabled", false), jSONObject.optBoolean("non_malicious_reporting_enabled", false), iy.a(jSONObject.optJSONArray("allowed_headers"), null), jSONObject.optBoolean("protection_enabled", false), jSONObject.optBoolean("malicious_reporting_enabled", false), iy.a(jSONObject.optJSONArray("webview_permissions"), null));
        return zzaiq;
    }
