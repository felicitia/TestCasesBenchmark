...
public abstract class zzle extends zzek implements zzld {
    ...
    public final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                iInterface = createBannerAdManager(Stub.asInterface(parcel.readStrongBinder()), (zzjn) aej.a(parcel, zzjn.CREATOR), parcel.readString(), zzxo.zzr(parcel.readStrongBinder()), parcel.readInt());
                break;
            case 2:
                iInterface = createInterstitialAdManager(Stub.asInterface(parcel.readStrongBinder()), (zzjn) aej.a(parcel, zzjn.CREATOR), parcel.readString(), zzxo.zzr(parcel.readStrongBinder()), parcel.readInt());
                break;
            case 3:
            ...
            case 9:
                ...
                break;
            case 10:
                iInterface = createSearchAdManager(Stub.asInterface(parcel.readStrongBinder()), (zzjn) aej.a(parcel, zzjn.CREATOR), parcel.readString(), parcel.readInt());
                break;
            case 11:
