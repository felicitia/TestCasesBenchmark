...
public abstract class zzbah implements Serializable, Iterable<Byte> {
    private static final wi a = (wb.a() ? new wk(null) : new wh(null));
    public static final zzbah zzdpq = new zzbao(xj.b);
    private int zzdpa = 0;

    zzbah() {
    }

    static wj zzbo(int i) {
        return new wj(i, null);
    }

    public static zzbah zzc(byte[] bArr, int i, int i2) {
        return new zzbao(a.a(bArr, i, i2));
    }
    ...
    public static zzbah zzem(String str) {
        return new zzbao(str.getBytes(xj.a));
    }
