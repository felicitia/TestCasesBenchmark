...
public abstract class GservicesValue<T> {
    ...
    private static class zzd implements zza {
        ...
        public final Long getLong(String str, Long l) {
            return Long.valueOf(e.a(this.mContentResolver, str, l.longValue()));
        }

        public final String getString(String str, String str2) {
            return e.a(this.mContentResolver, str, str2);
        }

        public final Boolean zza(String str, Boolean bool) {
            return Boolean.valueOf(e.a(this.mContentResolver, str, bool.booleanValue()));
        }

        public final Double zza(String str, Double d) {
            String a = e.a(this.mContentResolver, str, (String) null);
            if (a != null) {
                try {
        ...
        public final Integer zza(String str, Integer num) {
            return Integer.valueOf(e.a(this.mContentResolver, str, num.intValue()));
        }
    ...
    public final T get() {
        ...
        L_0x0070:
            ...
            T r0 = r6.mDefaultValue
            return r0
        L_0x0076:
            java.lang.String r0 = r6.mKey
            T r1 = r6.mDefaultValue
            java.lang.Object r0 = r6.retrieveFromDirectBootCache(r4, r0, r1)
            return r0
        L_0x007f:
        ...
        L_0x0094:
            ...
            java.lang.Object r3 = r6.retrieve(r3)     // Catch:{ all -> 0x00a5 }
