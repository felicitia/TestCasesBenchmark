...
public final class ug implements py {
    private final byte[] a;
    private final byte[] b;
    private final SecretKeySpec c;
    private final int d;

    public ug(byte[] bArr, int i) throws GeneralSecurityException {
        if (i == 12 || i == 16) {
            this.d = i;
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        byte[] bArr3 = bArr;
        if (bArr3.length > (Integer.MAX_VALUE - this.d) - 16) {
            throw new GeneralSecurityException("plaintext too long");
        }
        byte[] bArr4 = new byte[(this.d + bArr3.length + 16)];
        byte[] a2 = vi.a(this.d);
        ...
        instance2.doFinal(bArr3, 0, bArr3.length, bArr4, this.d);
        byte[] a5 = a(instance, 2, bArr4, this.d, bArr3.length);
        int length = bArr3.length + this.d;
        for (int i = 0; i < 16; i++) {
            bArr4[length + i] = (byte) ((a4[i] ^ a3[i]) ^ a5[i]);
        }
        return bArr4;
    }
}
