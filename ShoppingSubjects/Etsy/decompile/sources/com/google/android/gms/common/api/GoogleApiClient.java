...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        private AbstractClientBuilder<? extends b, c> zzdh;
        ...
        public final ClientSettings buildClientSettings() {
            c cVar = c.a;
            if (this.zzdc.containsKey(a.f)) {
                cVar = (c) this.zzdc.get(a.f);
            }
            ClientSettings clientSettings = new ClientSettings(this.zzs, this.zzcv, this.zzdb, this.zzcx, this.zzcy, this.zzcz, this.zzda, cVar);
