...
public final class jp {
    ...
    public static void a(Context context, @Nullable String str, String str2, Bundle bundle, boolean z, js jsVar) {
        if (z) {
        ...
        jsVar.a(appendQueryParameter.toString());
    }
    ...
    private final void a(ViewGroup viewGroup, zzjn zzjn, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            int a2 = a(context, 3);
            frameLayout.addView(textView, new LayoutParams(zzjn.widthPixels - a2, zzjn.heightPixels - a2, 17));
    ...
    public static boolean b(String str) {
        ...
        if (str.startsWith((String) ajh.f().a(akl.e))) {
            return true;
        }
        try {
            return Class.forName(str).isAnnotationPresent(bu.class);
        } catch (Exception e2) {
            String str2 = "Fail to check class type for class ";
            String valueOf = String.valueOf(str);
            ka.a(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), e2);
            return false;
        }
    }
    ...
    public final void a(Context context, @Nullable String str, String str2, Bundle bundle, boolean z) {
        a(context, null, str2, bundle, true, new jq(this));
    }

    public final void a(ViewGroup viewGroup, zzjn zzjn, String str) {
        a(viewGroup, zzjn, str, (int) ViewCompat.MEASURED_STATE_MASK, -1);
    }

    public final void a(ViewGroup viewGroup, zzjn zzjn, String str, String str2) {
        ka.e(str2);
        a(viewGroup, zzjn, str, (int) SupportMenu.CATEGORY_MASK, (int) ViewCompat.MEASURED_STATE_MASK);
    }
}
