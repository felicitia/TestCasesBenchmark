            ...
            switch (i) {
                ...
                case 3:
                    if (!(this.zzrl == null || this.zzrf == null)) {
                        ...
                        StringBuilder sb = new StringBuilder(70 + String.valueOf(zzcw).length() + String.valueOf(packageName).length());
                    ...
                    if (!this.zzrg.bindService(this.zzrf.zzcw(), this.zzrf.getPackageName(), this.zzrf.getBindFlags(), this.zzrl, getRealClientName())) {
                        ...
                        StringBuilder sb2 = new StringBuilder(34 + String.valueOf(zzcw2).length() + String.valueOf(packageName2).length());
