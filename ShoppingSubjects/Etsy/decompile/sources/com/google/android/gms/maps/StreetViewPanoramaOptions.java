...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeByte(parcel, 6, c.a(this.zzby));
        SafeParcelWriter.writeByte(parcel, 7, c.a(this.zzap));
        SafeParcelWriter.writeByte(parcel, 8, c.a(this.zzbz));
        SafeParcelWriter.writeByte(parcel, 9, c.a(this.zzca));
        SafeParcelWriter.writeByte(parcel, 10, c.a(this.zzak));
