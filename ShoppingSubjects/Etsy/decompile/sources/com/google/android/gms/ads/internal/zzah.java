...
public final class zzah extends zzkl {
    ...
    zzah(Context context, String str, zzxn zzxn, zzang zzang, zzkh zzkh, zzqw zzqw, zzrl zzrl, zzqz zzqz, SimpleArrayMap<String, zzrf> simpleArrayMap, SimpleArrayMap<String, zzrc> simpleArrayMap2, zzpl zzpl, zzlg zzlg, bg bgVar, zzri zzri, zzjn zzjn, PublisherAdViewOptions publisherAdViewOptions) {
    ...
    public final void zzb(zzjj zzjj, int i) {
        if (((Boolean) ajh.f().a(akl.cl)).booleanValue() || this.zzxu == null) {
            zzbc zzbc = new zzbc(this.mContext, this.zzwc, zzjn.zzf(this.mContext), this.zzye, this.zzwh, this.zzyf);
    ...
    public final boolean zzde() {
        return ((Boolean) ajh.f().a(akl.aM)).booleanValue() && this.zzxw != null;
    }
    ...
    private final void zzi(int i) {
        if (this.zzxs != null) {
            try {
                ...
                gv.c("Failed calling onAdFailedToLoad.", e);
            }
        }
    }
    ...
    public final void zza(zzjj zzjj, int i) {
        ...
        runOnUiThread(new i(this, zzjj, i));
    }
