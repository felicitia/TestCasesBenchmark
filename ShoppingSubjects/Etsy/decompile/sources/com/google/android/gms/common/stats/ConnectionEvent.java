...
public final class ConnectionEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        StringBuilder sb = new StringBuilder(26 + String.valueOf(callingProcess).length() + String.valueOf(callingService).length() + String.valueOf(targetProcess).length() + String.valueOf(targetService).length() + String.valueOf(str).length());
        sb.append("\t");
