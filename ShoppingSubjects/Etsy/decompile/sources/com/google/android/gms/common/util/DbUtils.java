...
import com.google.android.gms.internal.stable.g;
import java.io.File;
...
public final class DbUtils {
    ...
    private static void zza(SQLiteDatabase sQLiteDatabase, String str, String... strArr) {
        ...
        Cursor query = sQLiteDatabase.query("SQLITE_MASTER", new String[]{ResponseConstants.NAME}, "type == ?", new String[]{str}, null, null, null);
        try {
