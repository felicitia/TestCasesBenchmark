    ...
    public static abstract class Stub extends zzb implements IResolveAccountCallbacks {
        ...
        public static class Proxy extends zza implements IResolveAccountCallbacks {
            ...
            public void onAccountResolutionComplete(ResolveAccountResponse resolveAccountResponse) throws RemoteException {
                ...
                a.a(obtainAndWriteInterfaceToken, (Parcelable) resolveAccountResponse);
        ...
        public boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            onAccountResolutionComplete((ResolveAccountResponse) a.a(parcel, ResolveAccountResponse.CREATOR));
