...
final class dd extends db {
    ...
    private static int a(byte[] bArr, int i, long j, int i2) {
        switch (i2) {
            case 0:
                return da.b(i);
            case 1:
                return da.b(i, cy.a(bArr, j));
            case 2:
                return da.b(i, (int) cy.a(bArr, j), (int) cy.a(bArr, j + 1));
            default:
    ...
    public final int a(int r12, byte[] r13, int r14, int r15) {
        ...
        L_0x003b:
            ...
            long r9 = r7 + r5
            byte r15 = com.google.android.gms.internal.icing.cy.a(r13, r7)
        ...
        L_0x0050:
            ...
            long r14 = r7 + r5
            byte r3 = com.google.android.gms.internal.icing.cy.a(r13, r7)
        ...
        L_0x0070:
            ...
            long r14 = r7 + r5
            byte r7 = com.google.android.gms.internal.icing.cy.a(r13, r7)
        ...
        L_0x00a3:
            long r7 = r9 + r5
            byte r14 = com.google.android.gms.internal.icing.cy.a(r13, r9)
        ...
        L_0x00b3:
            ...
            long r14 = r9 + r5
            byte r7 = com.google.android.gms.internal.icing.cy.a(r13, r9)
            if (r7 > r3) goto L_0x00d6
            long r7 = r14 + r5
            byte r14 = com.google.android.gms.internal.icing.cy.a(r13, r14)
            if (r14 <= r3) goto L_0x004f
        L_0x00d6:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.icing.dd.a(int, byte[], int, int):int");
    }
    ...
    public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < 128 && j < j3) {
                long j5 = j + 1;
                cy.a(bArr2, j, (byte) charAt3);
                j = j5;
            } else if (charAt3 < 2048 && j <= j3 - 2) {
                long j6 = j + 1;
                cy.a(bArr2, j, (byte) (960 | (charAt3 >>> 6)));
                j = j6 + 1;
                cy.a(bArr2, j6, (byte) ((charAt3 & '?') | 128));
            } else if ((charAt3 < 55296 || 57343 < charAt3) && j <= j3 - 3) {
                long j7 = j + 1;
                cy.a(bArr2, j, (byte) (480 | (charAt3 >>> 12)));
                long j8 = j7 + 1;
                cy.a(bArr2, j7, (byte) (((charAt3 >>> 6) & 63) | 128));
                long j9 = j8 + 1;
                cy.a(bArr2, j8, (byte) ((charAt3 & '?') | 128));
                j = j9;
            } else if (j <= j3 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j10 = j + 1;
                        cy.a(bArr2, j, (byte) (240 | (codePoint >>> 18)));
                        long j11 = j10 + 1;
                        cy.a(bArr2, j10, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j12 = j11 + 1;
                        cy.a(bArr2, j11, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = j12 + 1;
                        cy.a(bArr2, j12, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                    }
                } else {
                    i7 = i6;
