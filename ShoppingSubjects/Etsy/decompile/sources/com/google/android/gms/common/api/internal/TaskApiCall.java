...
public abstract class TaskApiCall<A extends AnyClient, ResultT> {
    ...
    public static class Builder<A extends AnyClient, ResultT> {
        ...
        public BiConsumer<A, g<ResultT>> zzmb;
        ...
        @KeepForSdk
        public Builder<A, ResultT> execute(BiConsumer<A, g<ResultT>> biConsumer) {
    ...
    @KeepForSdk
    public abstract void doExecute(A a, g<ResultT> gVar) throws RemoteException;
