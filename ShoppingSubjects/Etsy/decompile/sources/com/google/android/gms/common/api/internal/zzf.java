...
public final class zzf<ResultT> extends zzb {
    private final g<ResultT> zzdu;
    private final TaskApiCall<AnyClient, ResultT> zzdy;
    private final StatusExceptionMapper zzdz;

    public zzf(int i, TaskApiCall<AnyClient, ResultT> taskApiCall, g<ResultT> gVar, StatusExceptionMapper statusExceptionMapper) {
        super(i);
        this.zzdu = gVar;
    ...
    public final void zza(@NonNull Status status) {
        this.zzdu.b(this.zzdz.getException(status));
    }
