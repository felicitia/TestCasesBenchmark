...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    @Constructor
    public VisibleRegion(@Param(id = 2) LatLng latLng, @Param(id = 3) LatLng latLng2, @Param(id = 4) LatLng latLng3, @Param(id = 5) LatLng latLng4, @Param(id = 6) LatLngBounds latLngBounds2) {
