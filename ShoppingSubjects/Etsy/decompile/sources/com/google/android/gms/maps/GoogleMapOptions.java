...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static LatLngBounds zza(Context context, AttributeSet attributeSet) {
        ...
        if (context != null) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, a.MapAttrs);
            Float valueOf = obtainAttributes.hasValue(a.MapAttrs_latLngBoundsSouthWestLatitude) ? Float.valueOf(obtainAttributes.getFloat(a.MapAttrs_latLngBoundsSouthWestLatitude, 0.0f)) : null;
            Float valueOf2 = obtainAttributes.hasValue(a.MapAttrs_latLngBoundsSouthWestLongitude) ? Float.valueOf(obtainAttributes.getFloat(a.MapAttrs_latLngBoundsSouthWestLongitude, 0.0f)) : null;
            Float valueOf3 = obtainAttributes.hasValue(a.MapAttrs_latLngBoundsNorthEastLatitude) ? Float.valueOf(obtainAttributes.getFloat(a.MapAttrs_latLngBoundsNorthEastLatitude, 0.0f)) : null;
            Float valueOf4 = obtainAttributes.hasValue(a.MapAttrs_latLngBoundsNorthEastLongitude) ? Float.valueOf(obtainAttributes.getFloat(a.MapAttrs_latLngBoundsNorthEastLongitude, 0.0f)) : null;
            obtainAttributes.recycle();
    ...
    public static CameraPosition zzb(Context context, AttributeSet attributeSet) {
        ...
        if (obtainAttributes.hasValue(a.MapAttrs_cameraZoom)) {
            builder.a(obtainAttributes.getFloat(a.MapAttrs_cameraZoom, 0.0f));
        }
        if (obtainAttributes.hasValue(a.MapAttrs_cameraBearing)) {
            builder.c(obtainAttributes.getFloat(a.MapAttrs_cameraBearing, 0.0f));
        }
        if (obtainAttributes.hasValue(a.MapAttrs_cameraTilt)) {
            builder.b(obtainAttributes.getFloat(a.MapAttrs_cameraTilt, 0.0f));
        }
        obtainAttributes.recycle();
        return builder.a();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeByte(parcel, 2, c.a(this.zzaj));
        SafeParcelWriter.writeByte(parcel, 3, c.a(this.zzak));
        SafeParcelWriter.writeInt(parcel, 4, getMapType());
        SafeParcelWriter.writeParcelable(parcel, 5, getCamera(), i, false);
        SafeParcelWriter.writeByte(parcel, 6, c.a(this.zzam));
        SafeParcelWriter.writeByte(parcel, 7, c.a(this.zzan));
        SafeParcelWriter.writeByte(parcel, 8, c.a(this.zzao));
        SafeParcelWriter.writeByte(parcel, 9, c.a(this.zzap));
        SafeParcelWriter.writeByte(parcel, 10, c.a(this.zzaq));
        SafeParcelWriter.writeByte(parcel, 11, c.a(this.zzar));
        SafeParcelWriter.writeByte(parcel, 12, c.a(this.zzas));
        SafeParcelWriter.writeByte(parcel, 14, c.a(this.zzat));
        SafeParcelWriter.writeByte(parcel, 15, c.a(this.zzau));
