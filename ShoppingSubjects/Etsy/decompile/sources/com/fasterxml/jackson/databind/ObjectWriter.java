...
public class ObjectWriter implements Versioned, Serializable {
    ...
    public ObjectWriter with(PrettyPrinter prettyPrinter) {
        ...
        ObjectWriter objectWriter = new ObjectWriter(this, this._config, this._rootType, this._rootSerializer, prettyPrinter, this._schema);
        return objectWriter;
    }
    ...
    public ObjectWriter withSchema(FormatSchema formatSchema) {
        ...
        ObjectWriter objectWriter = new ObjectWriter(this, this._config, this._rootType, this._rootSerializer, this._prettyPrinter, formatSchema);
        return objectWriter;
    }

    public ObjectWriter withType(JavaType javaType) {
        JavaType withStaticTyping = javaType.withStaticTyping();
        ObjectWriter objectWriter = new ObjectWriter(this, this._config, withStaticTyping, _prefetchRootSerializer(this._config, withStaticTyping), this._prettyPrinter, this._schema);
        return objectWriter;
    }
