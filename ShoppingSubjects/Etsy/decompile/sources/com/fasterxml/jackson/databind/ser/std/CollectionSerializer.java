...
public class CollectionSerializer extends AsArraySerializerBase<Collection<?>> {
    ...
    public ContainerSerializer<?> _withValueTypeSerializer(TypeSerializer typeSerializer) {
        CollectionSerializer collectionSerializer = new CollectionSerializer(this._elementType, this._staticTyping, typeSerializer, this._property, this._elementSerializer);
