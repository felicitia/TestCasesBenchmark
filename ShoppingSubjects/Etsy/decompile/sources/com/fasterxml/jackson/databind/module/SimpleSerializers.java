...
public class SimpleSerializers extends Base implements Serializable {
    ...
    public void addSerializer(JsonSerializer<?> jsonSerializer) {
        ...
        if (handledType == null || handledType == Object.class) {
            ...
            sb.append("JsonSerializer of type ");
            sb.append(jsonSerializer.getClass().getName());
            sb.append(" does not define valid handledType() -- must either register with method that takes type argument ");
            sb.append(" or make serializer extend 'com.fasterxml.jackson.databind.ser.std.StdSerializer'");
