...
public class ArrayBlockingQueueDeserializer extends CollectionDeserializer {
    ...
    public ArrayBlockingQueueDeserializer withResolved(JsonDeserializer<?> jsonDeserializer, JsonDeserializer<?> jsonDeserializer2, TypeDeserializer typeDeserializer) {
        ...
        ArrayBlockingQueueDeserializer arrayBlockingQueueDeserializer = new ArrayBlockingQueueDeserializer(this._collectionType, jsonDeserializer2, typeDeserializer, this._valueInstantiator, jsonDeserializer);
