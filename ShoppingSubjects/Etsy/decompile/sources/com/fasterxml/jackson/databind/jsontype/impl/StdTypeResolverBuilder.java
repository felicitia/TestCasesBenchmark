...
public class StdTypeResolverBuilder implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    public TypeDeserializer buildTypeDeserializer(DeserializationConfig deserializationConfig, JavaType javaType, Collection<NamedType> collection) {
        ...
        switch (this._includeAs) {
            case WRAPPER_ARRAY:
                AsArrayTypeDeserializer asArrayTypeDeserializer = new AsArrayTypeDeserializer(javaType, idResolver, this._typeProperty, this._typeIdVisible, this._defaultImpl);
                return asArrayTypeDeserializer;
            case PROPERTY:
                AsPropertyTypeDeserializer asPropertyTypeDeserializer = new AsPropertyTypeDeserializer(javaType, idResolver, this._typeProperty, this._typeIdVisible, this._defaultImpl);
                return asPropertyTypeDeserializer;
            case WRAPPER_OBJECT:
                AsWrapperTypeDeserializer asWrapperTypeDeserializer = new AsWrapperTypeDeserializer(javaType, idResolver, this._typeProperty, this._typeIdVisible, this._defaultImpl);
                return asWrapperTypeDeserializer;
            case EXTERNAL_PROPERTY:
                AsExternalTypeDeserializer asExternalTypeDeserializer = new AsExternalTypeDeserializer(javaType, idResolver, this._typeProperty, this._typeIdVisible, this._defaultImpl);
