...
public final class AnnotatedClass extends Annotated {
    ...
    public AnnotatedClass withAnnotations(AnnotationMap annotationMap) {
        AnnotatedClass annotatedClass = new AnnotatedClass(this._class, this._superTypes, this._annotationIntrospector, this._mixInResolver, annotationMap);
    ...
    private void resolveMemberMethods() {
        ...
        for (Class cls : this._superTypes) {
            _addMemberMethods(cls, this._memberMethods, this._mixInResolver == null ? null : this._mixInResolver.findMixInClassFor(cls), annotatedMethodMap);
        }
