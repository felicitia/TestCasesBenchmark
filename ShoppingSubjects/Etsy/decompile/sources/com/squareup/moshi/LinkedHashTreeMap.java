...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    LinkedHashTreeMap(java.util.Comparator r2) {
        /*
            r1 = this;
            r1.<init>()
            r0 = 0
        ...
        L_0x000d:
            r1.comparator = r2
            com.squareup.moshi.LinkedHashTreeMap$f r2 = new com.squareup.moshi.LinkedHashTreeMap$f
            r2.<init>()
            r1.header = r2
            r2 = 16
            com.squareup.moshi.LinkedHashTreeMap$f[] r2 = new com.squareup.moshi.LinkedHashTreeMap.f[r2]
            r1.table = r2
            com.squareup.moshi.LinkedHashTreeMap$f<K, V>[] r2 = r1.table
            int r2 = r2.length
            int r2 = r2 / 2
            com.squareup.moshi.LinkedHashTreeMap$f<K, V>[] r0 = r1.table
            int r0 = r0.length
            int r0 = r0 / 4
            int r2 = r2 + r0
            r1.threshold = r2
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.squareup.moshi.LinkedHashTreeMap.<init>(java.util.Comparator):void");
    }
