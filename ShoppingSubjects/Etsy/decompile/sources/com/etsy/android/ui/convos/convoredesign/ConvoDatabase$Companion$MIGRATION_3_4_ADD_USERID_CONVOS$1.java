...
public final class ConvoDatabase$Companion$MIGRATION_3_4_ADD_USERID_CONVOS$1 extends a {
    ConvoDatabase$Companion$MIGRATION_3_4_ADD_USERID_CONVOS$1(int i, int i2) {
        super(i, i2);
    }

    public void migrate(android.arch.persistence.db.a aVar) {
        p.b(aVar, "database");
        aVar.c("DROP TABLE convos");
