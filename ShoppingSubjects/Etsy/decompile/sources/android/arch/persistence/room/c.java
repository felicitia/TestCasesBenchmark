...
public class c {
    @NonNull
    public static <T extends RoomDatabase> a<T> a(@NonNull Context context, @NonNull Class<T> cls, @NonNull String str) {
    ...
    @NonNull
    public static <T extends RoomDatabase> a<T> a(@NonNull Context context, @NonNull Class<T> cls) {
