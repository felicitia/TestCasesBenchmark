...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f8 = f6 / ((this.mRawShadowSize - (this.mRawShadowSize * SHADOW_HORIZ_SCALE)) + f6);
        float f9 = f6 / ((this.mRawShadowSize - (this.mRawShadowSize * SHADOW_TOP_SCALE)) + f6);
    ...
    private void buildShadowCorners() {
        ...
        float f4 = rectF.top;
        LinearGradient linearGradient = new LinearGradient(0.0f, f4, 0.0f, rectF2.top, new int[]{this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, SHADOW_HORIZ_SCALE, 1.0f}, TileMode.CLAMP);
