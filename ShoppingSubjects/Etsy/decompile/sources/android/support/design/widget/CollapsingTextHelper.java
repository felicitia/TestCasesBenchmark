...
final class CollapsingTextHelper {
    ...
    public CollapsingTextHelper(View view) {
        this.mView = view;
        this.mTextPaint = new TextPaint(GmsClientSupervisor.DEFAULT_BIND_FLAGS);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTextToDraw != null && this.mDrawTitle) {
            ...
            if (z) {
                canvas.drawBitmap(this.mExpandedTitleTexture, f2, f7, this.mTexturePaint);
            } else {
                canvas.drawText(this.mTextToDraw, 0, this.mTextToDraw.length(), f2, f7, this.mTextPaint);
            }
        }
