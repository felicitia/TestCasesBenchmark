    ...
    public void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (z2) {
            ...
            for (int i17 = 0; i17 < i14; i17++) {
                ...
                measureChild(view2, ErrorDialogData.SUPPRESSED, true);
        ...
        for (int i18 = 0; i18 < i14; i18++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i15) {
                ...
                if (this.mOrientation == 1) {
                    int childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, ErrorDialogData.SUPPRESSED, i20, layoutParams.width, false);
                    i8 = MeasureSpec.makeMeasureSpec(i15 - i19, ErrorDialogData.SUPPRESSED);
                    i7 = childMeasureSpec;
                } else {
                    i7 = MeasureSpec.makeMeasureSpec(i15 - i20, ErrorDialogData.SUPPRESSED);
                    i8 = getChildMeasureSpec(spaceForSpanRange, ErrorDialogData.SUPPRESSED, i19, layoutParams.height, false);
                }
