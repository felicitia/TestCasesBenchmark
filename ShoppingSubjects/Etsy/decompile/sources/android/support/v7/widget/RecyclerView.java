...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static abstract class LayoutManager {
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = ErrorDialogData.SUPPRESSED;
            this.mHeightMode = ErrorDialogData.SUPPRESSED;
        }
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), ErrorDialogData.SUPPRESSED));
        }
    ...
    public final class Recycler {
        ...
        public android.support.v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r18, boolean r19, long r20) {
            ...
            L_0x0014:
                ...
                android.support.v7.widget.RecyclerView$ViewHolder r1 = r17.getChangedScrapViewForPosition(r18)
            ...
            L_0x002b:
                ...
                android.support.v7.widget.RecyclerView$ViewHolder r1 = r17.getScrapOrHiddenOrCachedHolderForPosition(r18, r19)
                if (r1 == 0) goto L_0x005f
            ...
            L_0x00f0:
                ...
                android.support.v7.widget.RecyclerView$RecycledViewPool r0 = r17.getRecycledViewPool()
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            L_0x0086:
                ...
                android.support.v7.widget.RecyclerView r7 = android.support.v7.widget.RecyclerView.this
                android.support.v7.widget.RecyclerView$LayoutManager r7 = r7.mLayout
                android.support.v7.widget.RecyclerView r8 = android.support.v7.widget.RecyclerView.this
                android.support.v7.widget.RecyclerView$Recycler r8 = r8.mRecycler
                android.support.v7.widget.RecyclerView r9 = android.support.v7.widget.RecyclerView.this
        ...
        if (this.mLayout.mAutoMeasure) {
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), ErrorDialogData.SUPPRESSED));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
