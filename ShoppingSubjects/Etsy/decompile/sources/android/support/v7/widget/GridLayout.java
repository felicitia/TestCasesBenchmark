...
public class GridLayout extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.mHorizontalAxis.layout((i6 - paddingLeft) - paddingRight);
        this.mVerticalAxis.layout((i7 - paddingTop) - paddingBottom);
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                Bounds bounds = (Bounds) this.mHorizontalAxis.getGroupBounds().getValue(i8);
                Bounds bounds2 = (Bounds) this.mVerticalAxis.getGroupBounds().getValue(i8);
                int i13 = measurement2;
                iArr2 = locations;
                int gravityOffset = absoluteAlignment.getGravityOffset(childAt, i11 - bounds.size(true));
                Alignment alignment = absoluteAlignment;
                int gravityOffset2 = absoluteAlignment2.getGravityOffset(childAt, i12 - bounds2.size(true));
                ...
                int i16 = measurement;
                View view = childAt;
                int offset = bounds3.getOffset(this, childAt, alignment3, measurement + i14, true);
                int i17 = i15;
                View view2 = view;
                i5 = childCount;
                int i18 = i17;
                int offset2 = bounds4.getOffset(this, view2, alignment4, i17 + margin4, false);
                int sizeInCell = alignment3.getSizeInCell(view2, i16, i11 - i14);
                int sizeInCell2 = alignment4.getSizeInCell(view2, i18, i12 - margin4);
                int i19 = i9 + gravityOffset + offset;
                int i20 = !isLayoutRtlCompat() ? paddingLeft + margin + i19 : (((i6 - sizeInCell) - paddingRight) - margin3) - i19;
                int i21 = paddingTop + i10 + gravityOffset2 + offset2 + margin2;
                if (!(sizeInCell == view2.getMeasuredWidth() && sizeInCell2 == view2.getMeasuredHeight())) {
                    view2.measure(MeasureSpec.makeMeasureSpec(sizeInCell, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(sizeInCell2, ErrorDialogData.SUPPRESSED));
                }
                view2.layout(i20, i21, sizeInCell + i20, sizeInCell2 + i21);
            }
            i8++;
            locations = iArr2;
            z3 = z2;
