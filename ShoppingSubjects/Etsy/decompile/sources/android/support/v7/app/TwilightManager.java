...
class TwilightManager {
    ...
    static TwilightManager getInstance(@NonNull Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(applicationContext, (LocationManager) applicationContext.getSystemService(ResponseConstants.LOCATION));
        }
        return sInstance;
    }
    ...
    private void updateState(@NonNull Location location) {
        ...
        if (j6 == -1 || j5 == -1) {
            ...
            j = j8 + DateUtils.MILLIS_PER_MINUTE;
        }
        TwilightState twilightState3 = twilightState2;
        twilightState3.isNight = z3;
        twilightState3.yesterdaySunset = j4;
        twilightState3.todaySunrise = j6;
        twilightState3.todaySunset = j5;
        twilightState3.tomorrowSunrise = j7;
