...
public final class InputConnectionCompat {
    ...
    static final class InputContentInfoCompatBaseImpl implements InputConnectionCompatImpl {
        ...
        static boolean handlePerformPrivateCommand(@android.support.annotation.Nullable java.lang.String r7, @android.support.annotation.NonNull android.os.Bundle r8, @android.support.annotation.NonNull android.support.v13.view.inputmethod.InputConnectionCompat.OnCommitContentListener r9) {
            /*
                java.lang.String r0 = COMMIT_CONTENT_ACTION
            ...
            L_0x000d:
                r7 = 0
                java.lang.String r1 = COMMIT_CONTENT_RESULT_RECEIVER     // Catch:{ all -> 0x004d }
                ...
                java.lang.String r2 = COMMIT_CONTENT_CONTENT_URI_KEY     // Catch:{ all -> 0x004b }
                android.os.Parcelable r2 = r8.getParcelable(r2)     // Catch:{ all -> 0x004b }
                android.net.Uri r2 = (android.net.Uri) r2     // Catch:{ all -> 0x004b }
                java.lang.String r3 = COMMIT_CONTENT_DESCRIPTION_KEY     // Catch:{ all -> 0x004b }
                ...
                java.lang.String r4 = COMMIT_CONTENT_LINK_URI_KEY     // Catch:{ all -> 0x004b }
                android.os.Parcelable r4 = r8.getParcelable(r4)     // Catch:{ all -> 0x004b }
                android.net.Uri r4 = (android.net.Uri) r4     // Catch:{ all -> 0x004b }
                java.lang.String r5 = COMMIT_CONTENT_FLAGS_KEY     // Catch:{ all -> 0x004b }
                int r5 = r8.getInt(r5)     // Catch:{ all -> 0x004b }
                java.lang.String r6 = COMMIT_CONTENT_OPTS_KEY     // Catch:{ all -> 0x004b }
            ...
            L_0x0054:
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v13.view.inputmethod.InputConnectionCompat.InputContentInfoCompatBaseImpl.handlePerformPrivateCommand(java.lang.String, android.os.Bundle, android.support.v13.view.inputmethod.InputConnectionCompat$OnCommitContentListener):boolean");
        }
    }
