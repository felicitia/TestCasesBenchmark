...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final TextView textView, int i, int i2, final int i3) {
        ...
        if (z) {
            ...
            AnonymousClass2 r5 = new ReplyCallback<Typeface>() {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        String str2 = str;
        ArrayList arrayList = new ArrayList();
        Uri build = new Builder().scheme(ResponseConstants.CONTENT).authority(str2).build();
        Uri build2 = new Builder().scheme(ResponseConstants.CONTENT).authority(str2).appendPath(ResponseConstants.FILE).build();
        Cursor cursor = null;
        try {
            int i = 0;
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    FontInfo fontInfo = new FontInfo(withAppendedId, i3, columnIndex5 != -1 ? cursor2.getInt(columnIndex5) : 400, columnIndex6 != -1 && cursor2.getInt(columnIndex6) == 1, i2);
