    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void registerCallback(android.support.v4.media.session.MediaControllerCompat.Callback r3, android.os.Handler r4) {
            ...
            L_0x0029:
                ...
                monitor-enter(r4)
                java.util.List<android.support.v4.media.session.MediaControllerCompat$Callback> r0 = r2.mPendingCallbacks     // Catch:{ all -> 0x0033 }
        ...
        public final void unregisterCallback(android.support.v4.media.session.MediaControllerCompat.Callback r3) {
            /*
                ...
                android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback r3 = (android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback) r3     // Catch:{ RemoteException -> 0x001d }
                if (r3 == 0) goto L_0x002f
                android.support.v4.media.session.IMediaSession r0 = r2.mExtraBinder     // Catch:{ RemoteException -> 0x001d }
            ...
            L_0x0026:
                ...
                monitor-enter(r0)
                java.util.List<android.support.v4.media.session.MediaControllerCompat$Callback> r1 = r2.mPendingCallbacks     // Catch:{ all -> 0x0030 }
