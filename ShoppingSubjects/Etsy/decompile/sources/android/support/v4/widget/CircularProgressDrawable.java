    ...
    public void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            if (f < SHRINK_OFFSET) {
                ...
                f2 = (0.79f * MATERIAL_INTERPOLATOR.getInterpolation(f4)) + MIN_PROGRESS_ARC + startingStartTrim;
            } else {
                f2 = ring.getStartingStartTrim() + 0.79f;
                f3 = f2 - ((0.79f * (1.0f - MATERIAL_INTERPOLATOR.getInterpolation((f - SHRINK_OFFSET) / SHRINK_OFFSET))) + MIN_PROGRESS_ARC);
            }
