...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime < 0 || j < this.mStopTime) {
                return 0.5f * AutoScrollHelper.constrain(((float) (j - this.mStartTime)) / ((float) this.mRampUpDuration), 0.0f, 1.0f);
            }
    ...
    public AutoScrollHelper(View view) {
        ...
        setRampUpDuration(AbstractContextRecyclerViewAdapter.VIEW_TYPE_HEADER);
        setRampDownDuration(AbstractContextRecyclerViewAdapter.VIEW_TYPE_HEADER);
    }
