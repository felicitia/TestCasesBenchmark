...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @NonNull double[] dArr) {
        ...
        dArr2[0] = ((0.4124d * d3) + (0.3576d * d5) + (0.1805d * d)) * XYZ_WHITE_REFERENCE_Y;
        dArr2[1] = ((0.2126d * d3) + (0.7152d * d5) + (0.0722d * d)) * XYZ_WHITE_REFERENCE_Y;
        dArr2[2] = XYZ_WHITE_REFERENCE_Y * ((d3 * 0.0193d) + (d5 * 0.1192d) + (d * 0.9505d));
    }
