...
public final class Range<T> implements Serializable {
    ...
    private Range(T t, T t2, Comparator<T> comparator2) {
        ...
        if (comparator2 == null) {
            comparator2 = ComparableComparator.INSTANCE;
        }
    ...
    public boolean isAfter(T t) {
        ...
        if (this.comparator.compare(t, this.minimum) < 0) {
            z = true;
        }
        return z;
    }
    ...
    public boolean isEndedBy(T t) {
        ...
        if (this.comparator.compare(t, this.maximum) == 0) {
            z = true;
        }
        return z;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = this.maximum.hashCode() + (37 * (((629 + getClass().hashCode()) * 37) + this.minimum.hashCode()));
