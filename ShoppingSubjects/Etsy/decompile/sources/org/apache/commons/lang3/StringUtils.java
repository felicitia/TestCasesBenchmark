...
public class StringUtils {
    ...
    private static String replaceEach(String str, String[] strArr, String[] strArr2, boolean z, int i) {
        ...
        if (length != length2) {
            StringBuilder sb = new StringBuilder();
            sb.append("Search and Replace array lengths don't match: ");
            sb.append(length);
            sb.append(" vs ");
            sb.append(length2);
        ...
        StringBuilder sb2 = new StringBuilder(str.length() + Math.min(i5, str.length() / 5));
        int i7 = 0;
        while (i2 != -1) {
            while (i7 < i2) {
        ...
        return replaceEach(sb3, strArr, strArr2, z, i - 1);
    }
    ...
    public static int indexOfDifference(CharSequence... charSequenceArr) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            if (charSequenceArr[i3] == null) {
                ...
                int min = Math.min(charSequenceArr[i3].length(), i2);
                i = Math.max(charSequenceArr[i3].length(), i);
                i2 = min;
                z = false;
            }
        }
