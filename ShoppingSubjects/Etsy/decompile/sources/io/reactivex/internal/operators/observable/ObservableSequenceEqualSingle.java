...
public final class ObservableSequenceEqualSingle<T> extends v<Boolean> {
    final t<? extends T> a;
    final t<? extends T> b;
    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        EqualCoordinator(x<? super Boolean> xVar, int i, t<? extends T> tVar, t<? extends T> tVar2, d<? super T, ? super T> dVar) {
            this.actual = xVar;
            this.first = tVar;
            this.second = tVar2;
            this.comparer = dVar;
