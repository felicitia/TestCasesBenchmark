...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public void setShadowSize(float f, float f2) {
        if (f < 0.0f) {
            ...
            if (this.mRawShadowSize != even || this.mRawMaxShadowSize != even2) {
                ...
                this.mMaxShadowSize = even2 + ((float) this.mInsetShadow);
                this.mDirty = true;
                invalidateSelf();
            }
        }
    ...
    private void buildShadowCorners() {
        ...
        RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, this.mCornerRadius + this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, f, 1.0f}, TileMode.CLAMP);
        paint.setShader(radialGradient);
        Paint paint2 = this.mEdgeShadowPaint;
        LinearGradient linearGradient = new LinearGradient(0.0f, (-this.mCornerRadius) + this.mShadowSize, 0.0f, (-this.mCornerRadius) - this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, TileMode.CLAMP);
