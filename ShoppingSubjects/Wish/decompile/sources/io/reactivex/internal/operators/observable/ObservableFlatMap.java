    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void drainLoop() {
            ...
            L_0x00f5:
                ...
                monitor-enter(r13)
                java.util.Queue<io.reactivex.ObservableSource<? extends U>> r3 = r13.sources     // Catch:{ all -> 0x0117 }
                java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0117 }
                io.reactivex.ObservableSource r3 = (io.reactivex.ObservableSource) r3     // Catch:{ all -> 0x0117 }
                if (r3 != 0) goto L_0x0111
                int r3 = r13.wip     // Catch:{ all -> 0x0117 }
                int r3 = r3 - r1
                r13.wip = r3     // Catch:{ all -> 0x0117 }
                monitor-exit(r13)     // Catch:{ all -> 0x0117 }
                goto L_0x0004
            L_0x0111:
                monitor-exit(r13)     // Catch:{ all -> 0x0117 }
