        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (String.class != parameterUpperBound) {
                    ...
                    sb2.append(parameterUpperBound);
                ...
                if (Iterable.class.isAssignableFrom(rawType3)) {
                    if (!(type instanceof ParameterizedType)) {
                        ...
                        sb3.append(rawType3.getSimpleName());
                    ...
                    return new Header(value3, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType3.getComponentType()), annotationArr)).array();
                }
                ...
                if (String.class != parameterUpperBound2) {
                    ...
                    sb4.append(parameterUpperBound2);
                ...
                if (Iterable.class.isAssignableFrom(rawType5)) {
                    if (!(type instanceof ParameterizedType)) {
                        ...
                        sb5.append(rawType5.getSimpleName());
                        sb5.append(" must include generic type (e.g., ");
                        sb5.append(rawType5.getSimpleName());
                        sb5.append("<String>)");
                        throw parameterError(i, sb5.toString(), new Object[0]);
                    }
                    return new Field(value4, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded2).iterable();
                } else if (!rawType5.isArray()) {
                    return new Field(value4, this.retrofit.stringConverter(type, annotationArr), encoded2);
                } else {
                    return new Field(value4, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType5.getComponentType()), annotationArr), encoded2).array();
                }
                ...
                if (String.class != parameterUpperBound3) {
                    ...
                    sb6.append(parameterUpperBound3);
                ...
                if (!value5.isEmpty()) {
                    ...
                    sb7.append(value5);
                    sb7.append("\"");
                    Headers of = Headers.of("Content-Disposition", sb7.toString(), "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType7)) {
                        if (!(type instanceof ParameterizedType)) {
                            StringBuilder sb8 = new StringBuilder();
                            sb8.append(rawType7.getSimpleName());
                            sb8.append(" must include generic type (e.g., ");
                            sb8.append(rawType7.getSimpleName());
                            sb8.append("<String>)");
                            throw parameterError(i, sb8.toString(), new Object[0]);
                        }
                    ...
                    if (!(type instanceof ParameterizedType)) {
                        ...
                        sb9.append(rawType7.getSimpleName());
                ...
                if (String.class != parameterUpperBound5) {
                    ...
                    sb10.append(parameterUpperBound5);
