...
public final class Http2Stream {
    ...
    private final class FramingSource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x009b, code lost:
            if (r7.this$0.connection.unacknowledgedBytesRead < ((long) (r7.this$0.connection.okHttpSettings.getInitialWindowSize() / 2))) goto L_0x00b1;
         */
        ...
        public long read(okio.Buffer r8, long r9) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                okio.Buffer r3 = r7.readBuffer     // Catch:{ all -> 0x00b6 }
            ...
            L_0x0034:
                okio.Buffer r3 = r7.readBuffer     // Catch:{ all -> 0x00b6 }
                okio.Buffer r4 = r7.readBuffer     // Catch:{ all -> 0x00b6 }
                long r4 = r4.size()     // Catch:{ all -> 0x00b6 }
                long r9 = java.lang.Math.min(r9, r4)     // Catch:{ all -> 0x00b6 }
                long r8 = r3.read(r8, r9)     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Stream r10 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b6 }
                long r3 = r10.unacknowledgedBytesRead     // Catch:{ all -> 0x00b6 }
                r5 = 0
                long r5 = r3 + r8
                ...
                long r3 = r10.unacknowledgedBytesRead     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Stream r10 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Connection r10 = r10.connection     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Settings r10 = r10.okHttpSettings     // Catch:{ all -> 0x00b6 }
                int r10 = r10.getInitialWindowSize()     // Catch:{ all -> 0x00b6 }
                int r10 = r10 / 2
                ...
                okhttp3.internal.http2.Http2Stream r10 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Connection r10 = r10.connection     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Stream r3 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b6 }
                int r3 = r3.id     // Catch:{ all -> 0x00b6 }
                okhttp3.internal.http2.Http2Stream r4 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b6 }
                long r4 = r4.unacknowledgedBytesRead     // Catch:{ all -> 0x00b6 }
            ...
            L_0x0075:
                ...
                long r3 = r2.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
                r5 = 0
                long r5 = r3 + r8
                r2.unacknowledgedBytesRead = r5     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Http2Stream r2 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Http2Connection r2 = r2.connection     // Catch:{ all -> 0x00b3 }
                long r2 = r2.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Http2Stream r4 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Http2Connection r4 = r4.connection     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Settings r4 = r4.okHttpSettings     // Catch:{ all -> 0x00b3 }
                int r4 = r4.getInitialWindowSize()     // Catch:{ all -> 0x00b3 }
                int r4 = r4 / 2
                long r4 = (long) r4     // Catch:{ all -> 0x00b3 }
                ...
                okhttp3.internal.http2.Http2Stream r4 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00b3 }
                okhttp3.internal.http2.Http2Connection r4 = r4.connection     // Catch:{ all -> 0x00b3 }
                long r4 = r4.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
        ...
        public void receive(BufferedSource bufferedSource, long j) throws IOException {
            ...
            while (j > 0) {
                synchronized (Http2Stream.this) {
                    z = this.finished;
                    z2 = false;
                    z3 = j + this.readBuffer.size() > this.maxByteCount;
                }
                if (z3) {
