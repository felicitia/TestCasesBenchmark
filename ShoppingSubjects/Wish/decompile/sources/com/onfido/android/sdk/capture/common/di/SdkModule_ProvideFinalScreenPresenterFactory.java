...
public final class SdkModule_ProvideFinalScreenPresenterFactory implements b<FinalScreenPresenter> {
    ...
    public FinalScreenPresenter get() {
        return (FinalScreenPresenter) d.a(this.b.provideFinalScreenPresenter((AnalyticsInteractor) this.c.get()), "Cannot return null from a non-@Nullable @Provides method");
    }
}
