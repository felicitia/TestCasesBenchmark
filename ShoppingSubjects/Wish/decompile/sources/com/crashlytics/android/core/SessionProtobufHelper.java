...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<DeviceIdentifierType, String> map, int i3, String str3, String str4) throws Exception {
        ...
        ByteString byteString2 = stringToByteString2;
        codedOutputStream2.writeRawVarint32(getSessionDeviceSize(i, copyFromUtf8, stringToByteString, i2, j, j2, z, map, i3, stringToByteString3, stringToByteString2));
        ...
        if (byteString3 != null) {
            codedOutputStream2.writeBytes(13, byteString3);
        }
        ByteString byteString4 = byteString2;
        if (byteString4 != null) {
            codedOutputStream2.writeBytes(14, byteString4);
        }
    }
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        if (str4 == null) {
            ...
            copyFromUtf8 = ByteString.copyFromUtf8(str4.replace("-", ""));
        }
        ...
        codedOutputStream2.writeRawVarint32(getSessionEventSize(j, str, th, thread, stackTraceElementArr, threadArr, list, 8, map, runningAppProcessInfo, i, copyFromUtf82, byteString, f, i2, z, j2, j3, byteStringForLog));
        ...
        ByteString byteString2 = byteStringForLog;
        writeSessionEventApp(codedOutputStream3, th, thread, stackTraceElementArr, threadArr, list, 8, copyFromUtf82, byteString, map, runningAppProcessInfo, i);
        writeSessionEventDevice(codedOutputStream3, f, i2, z, i, j2, j3);
        writeSessionEventLog(codedOutputStream2, byteString2);
    }

    private static void writeSessionEventApp(CodedOutputStream codedOutputStream, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i2) throws Exception {
        codedOutputStream.writeTag(3, 2);
        codedOutputStream.writeRawVarint32(getEventAppSize(th, thread, stackTraceElementArr, threadArr, list, i, byteString, byteString2, map, runningAppProcessInfo, i2));
        writeSessionEventAppExecution(codedOutputStream, th, thread, stackTraceElementArr, threadArr, list, i, byteString, byteString2);
    ...
    private static void writeSessionEventAppExecution(CodedOutputStream codedOutputStream, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2) throws Exception {
        codedOutputStream.writeTag(1, 2);
        codedOutputStream.writeRawVarint32(getEventAppExecutionSize(th, thread, stackTraceElementArr, threadArr, list, i, byteString, byteString2));
        ...
        writeSessionEventAppExecutionException(codedOutputStream, th, 1, i, 2);
        codedOutputStream.writeTag(3, 2);
    ...
    private static void writeSessionEventAppExecutionException(CodedOutputStream codedOutputStream, Throwable th, int i, int i2, int i3) throws Exception {
        codedOutputStream.writeTag(i3, 2);
        codedOutputStream.writeRawVarint32(getEventAppExecutionExceptionSize(th, 1, i2));
        ...
        if (i < i2) {
            writeSessionEventAppExecutionException(codedOutputStream, cause, i + 1, i2, 6);
            return;
        }
        while (cause != null) {
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<DeviceIdentifierType, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        int i4;
        int i5;
        int i6 = 0;
        int computeBytesSize = CodedOutputStream.computeBytesSize(1, byteString) + 0 + CodedOutputStream.computeEnumSize(3, i);
        if (byteString2 == null) {
            i4 = 0;
        } else {
            i4 = CodedOutputStream.computeBytesSize(4, byteString2);
        }
        int computeUInt32Size = computeBytesSize + i4 + CodedOutputStream.computeUInt32Size(5, i2) + CodedOutputStream.computeUInt64Size(6, j) + CodedOutputStream.computeUInt64Size(7, j2) + CodedOutputStream.computeBoolSize(10, z);
        if (map != null) {
            for (Entry entry : map.entrySet()) {
    ...
    private static int getSessionEventSize(long j, String str, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i2, ByteString byteString, ByteString byteString2, float f, int i3, boolean z, long j2, long j3, ByteString byteString3) {
        ...
        int eventAppSize = getEventAppSize(th, thread, stackTraceElementArr, threadArr, list, i, byteString, byteString2, map, runningAppProcessInfo, i2);
    ...
    private static int getEventAppSize(Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i2) {
        int eventAppExecutionSize = getEventAppExecutionSize(th, thread, stackTraceElementArr, threadArr, list, i, byteString, byteString2);
    ...
    private static int getEventAppExecutionSize(Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2) {
        ...
        int eventAppExecutionExceptionSize = getEventAppExecutionExceptionSize(th, 1, i);
    ...
    private static int getEventAppExecutionExceptionSize(Throwable th, int i, int i2) {
        int i3 = 0;
        ...
        for (StackTraceElement frameSize : th.getStackTrace()) {
        ...
        if (i < i2) {
            int eventAppExecutionExceptionSize = getEventAppExecutionExceptionSize(cause, i + 1, i2);
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        sb.append(".");
        sb.append(stackTraceElement.getMethodName());
        int computeBytesSize = i + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(sb.toString()));
        if (stackTraceElement.getFileName() != null) {
