...
abstract class AbstractCheckForUpdatesController implements UpdatesController {
    ...
    private void performUpdateCheck() {
        ...
        CheckForUpdatesRequest checkForUpdatesRequest = new CheckForUpdatesRequest(this.beta, this.beta.getOverridenSpiEndpoint(), this.betaSettings.updateUrl, this.httpRequestFactory, new CheckForUpdatesResponseTransform());
