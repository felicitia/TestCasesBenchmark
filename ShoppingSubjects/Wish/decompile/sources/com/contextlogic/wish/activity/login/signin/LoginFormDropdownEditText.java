...
public class LoginFormDropdownEditText extends ThemedDropdownEditText {
    ...
    public LoginFormDropdownEditText(Context context) {
        super(context);
        init();
    }
    ...
    public LoginFormDropdownEditText(Context context, AttributeSet attributeSet, int i) {
    ...
    private void init() {
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                LoginFormDropdownEditText.this.handleTextChanged();
            }
        });
    }
