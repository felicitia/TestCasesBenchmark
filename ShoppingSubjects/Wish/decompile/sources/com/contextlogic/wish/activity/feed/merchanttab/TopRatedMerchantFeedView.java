...
public class TopRatedMerchantFeedView extends BaseMerchantFeedView {
    /* access modifiers changed from: protected */
    public int getEmptyText() {
        return R.string.merchant_feed_tab_no_top_rated_merchants;
    }

    public TopRatedMerchantFeedView(BaseProductFeedServiceFragment baseProductFeedServiceFragment) {
    ...
    public InfiniteDataFetcher<MerchantFeedItem> createPagingFetcher(final BaseProductFeedServiceFragment baseProductFeedServiceFragment) {
        return new InfiniteDataFetcher<MerchantFeedItem>() {
            public void fetch(int i, int i2, final InfiniteDataFinisher<MerchantFeedItem> infiniteDataFinisher) {
                baseProductFeedServiceFragment.fetchTopRatedMerchants(i, i2, new SuccessCallback() {
