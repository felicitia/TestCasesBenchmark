...
import com.contextlogic.wish.api.model.WishPromotionCouponSpec.BannerSmallSpec;
import com.contextlogic.wish.api.model.WishTextViewSpec;
import com.contextlogic.wish.ui.image.NetworkImageView;
import com.contextlogic.wish.ui.text.ThemedTextView;
import com.contextlogic.wish.util.ColorUtil;

public class PromotionBannerSmallCouponHeaderView extends BaseFeedHeaderView {
    private NetworkImageView mBackgroundImage;
    private ThemedTextView mTitle;

    public PromotionBannerSmallCouponHeaderView(Context context) {
        super(context);
        init();
    }
