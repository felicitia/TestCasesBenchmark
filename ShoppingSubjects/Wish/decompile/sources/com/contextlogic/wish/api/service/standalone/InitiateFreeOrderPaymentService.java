...
public class InitiateFreeOrderPaymentService extends SingleApiService {
    ...
    public void requestService(String str, String str2, int i, final SuccessCallback successCallback, final FailureCallback failureCallback) {
        ApiRequest apiRequest = new ApiRequest("payment/none/complete");
        ...
        startService(apiRequest, new ApiCallback() {
            ...
            public void handleFailure(final ApiResponse apiResponse, final String str) {
                if (failureCallback != null) {
                    InitiateFreeOrderPaymentService.this.postRunnable(new Runnable() {
                        public void run() {
