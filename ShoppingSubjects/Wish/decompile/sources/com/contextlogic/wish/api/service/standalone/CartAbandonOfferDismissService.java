...
public class CartAbandonOfferDismissService extends SingleApiService {
    public void requestService(String str, final DefaultSuccessCallback defaultSuccessCallback, final DefaultFailureCallback defaultFailureCallback) {
        ApiRequest apiRequest = new ApiRequest("cart-abandonment/dismiss");
        ...
        startService(apiRequest, new ApiCallback() {
            ...
            public void handleFailure(ApiResponse apiResponse, final String str) {
                if (defaultFailureCallback != null) {
                    CartAbandonOfferDismissService.this.postRunnable(new Runnable() {
                        public void run() {
