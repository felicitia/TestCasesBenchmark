...
public class LogLocalNotificationService extends SingleApiService {
    public void requestService(String str, String str2, final DefaultSuccessCallback defaultSuccessCallback, final DefaultFailureCallback defaultFailureCallback) {
        ApiRequest apiRequest = new ApiRequest("mobile/log-local-notification");
        apiRequest.addParameter("notification_id", (Object) str);
        apiRequest.addParameter("action", (Object) str2);
        startService(apiRequest, new ApiCallback() {
            ...
            public void handleFailure(ApiResponse apiResponse, final String str) {
                if (defaultFailureCallback != null) {
                    LogLocalNotificationService.this.postRunnable(new Runnable() {
                        public void run() {
