...
public class CashOutPaypalService extends SingleApiService {
    ...
    public void requestService(String str, String str2, final SuccessCallback successCallback, final DefaultFailureCallback defaultFailureCallback) {
        ApiRequest apiRequest = new ApiRequest("partner/cash-out/paypal");
        apiRequest.addParameter("amount", (Object) str);
        apiRequest.addParameter("payment_account_id", (Object) str2);
        startService(apiRequest, new ApiCallback() {
            ...
            public void handleSuccess(ApiResponse apiResponse) throws JSONException {
                ...
                if (successCallback != null) {
                    CashOutPaypalService.this.postRunnable(new Runnable() {
                        public void run() {
