...
public class InitiateEbanxPaymentService extends SingleApiService {
    ...
    public void requestService(String str, String str2, String str3, int i, final SuccessCallback successCallback, final FailureCallback failureCallback) {
        ApiRequest apiRequest = new ApiRequest("payment/ebanx/complete");
        ...
        if (str2 != null) {
            apiRequest.addParameter("cvv", (Object) str2);
        }
        if (str3 != null) {
        ...
        startService(apiRequest, new ApiCallback() {
            ...
            public void handleFailure(final ApiResponse apiResponse, final String str) {
                if (failureCallback != null) {
                    InitiateEbanxPaymentService.this.postRunnable(new Runnable() {
                        public void run() {
