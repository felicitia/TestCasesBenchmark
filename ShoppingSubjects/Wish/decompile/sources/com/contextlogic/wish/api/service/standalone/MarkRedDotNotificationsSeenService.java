...
public class MarkRedDotNotificationsSeenService extends SingleApiService {
    public void requestService(final DefaultSuccessCallback defaultSuccessCallback, final DefaultFailureCallback defaultFailureCallback) {
        startService(new ApiRequest("notification/red-dot-seen"), new ApiCallback() {
            ...
            public void handleFailure(ApiResponse apiResponse, final String str) {
                if (defaultFailureCallback != null) {
                    MarkRedDotNotificationsSeenService.this.postRunnable(new Runnable() {
                        public void run() {
