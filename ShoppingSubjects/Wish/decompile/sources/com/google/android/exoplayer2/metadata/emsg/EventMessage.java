...
public final class EventMessage implements Entry {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = ((((((((hashCode2 + i) * 31) + ((int) (this.presentationTimeUs ^ (this.presentationTimeUs >>> 32)))) * 31) + ((int) (this.durationMs ^ (this.durationMs >>> 32)))) * 31) + ((int) (this.id ^ (this.id >>> 32)))) * 31) + Arrays.hashCode(this.messageData);
        }
