...
public final class SampleQueue implements TrackOutput {
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (z) {
            ...
            iArr2[0] = 0;
            iArr4[0] = sampleExtrasHolder2.size - ((int) (j - sampleExtrasHolder2.offset));
        }
        ...
        int i4 = (int) (j - sampleExtrasHolder2.offset);
    ...
    public void sampleMetadata(long j, int i, int i2, int i3, CryptoData cryptoData) {
        ...
        int i4 = i2;
        this.metadataQueue.commitSample(j2 + this.sampleOffsetUs, i, (this.totalBytesWritten - ((long) i4)) - ((long) i3), i4, cryptoData);
    }
