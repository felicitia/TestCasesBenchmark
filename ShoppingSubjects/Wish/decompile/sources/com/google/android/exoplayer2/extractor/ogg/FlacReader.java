...
final class FlacReader extends StreamReader {
    ...
    private class FlacOggSeeker implements SeekMap, OggSeeker {
        ...
        public SeekPoints getSeekPoints(long j) {
            ...
            return new SeekPoints(seekPoint, new SeekPoint(FlacReader.this.convertGranuleToTime(this.seekPointGranules[i]), this.firstFrameOffset + this.seekPointOffsets[i]));
        }
