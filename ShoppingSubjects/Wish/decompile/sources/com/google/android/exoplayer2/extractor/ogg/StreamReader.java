...
abstract class StreamReader {
    ...
    private int readHeaders(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.setupData.oggSeeker != null) {
            ...
            DefaultOggSeeker defaultOggSeeker = new DefaultOggSeeker(this.payloadStartPosition, extractorInput.getLength(), this, pageHeader.headerSize + pageHeader.bodySize, pageHeader.granulePosition);
