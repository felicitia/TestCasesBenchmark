...
public final class PgsDecoder extends SimpleSubtitleDecoder {
    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            if (i % 5 == 2) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    ...
                    this.colors[i5] = Util.constrainValue(i7, 0, 255) | (Util.constrainValue(i6, 0, 255) << 8) | (readUnsignedByte5 << 24) | (Util.constrainValue(i4, 0, 255) << 16);
                }
                this.colorsSet = true;
            }
        }
        ...
        public Cue build() {
            ...
            Cue cue = new Cue(Bitmap.createBitmap(iArr, this.bitmapWidth, this.bitmapHeight, Config.ARGB_8888), ((float) this.bitmapX) / ((float) this.planeWidth), 0, ((float) this.bitmapY) / ((float) this.planeHeight), 0, ((float) this.bitmapWidth) / ((float) this.planeWidth), ((float) this.bitmapHeight) / ((float) this.planeHeight));
            return cue;
        }
