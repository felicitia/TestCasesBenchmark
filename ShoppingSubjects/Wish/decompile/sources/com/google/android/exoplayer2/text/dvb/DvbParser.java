...
final class DvbParser {
    ...
    public List<Cue> decode(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < sparseArray2.size(); i4++) {
            ...
            float f3 = f2;
            float f4 = f;
            this.canvas.clipRect(f, f2, (float) Math.min(regionComposition.width + i5, displayDefinition.horizontalPositionMaximum), (float) Math.min(regionComposition.height + i6, displayDefinition.verticalPositionMaximum), Op.REPLACE);
            ...
            Cue cue = new Cue(Bitmap.createBitmap(this.bitmap, i5, i6, regionComposition.width, regionComposition.height), f4 / ((float) displayDefinition.width), 0, f3 / ((float) displayDefinition.height), 0, ((float) regionComposition.width) / ((float) displayDefinition.width), ((float) regionComposition.height) / ((float) displayDefinition.height));
            arrayList.add(cue);
    ...
    /* JADX WARNING: type inference failed for: r16v0, types: [byte[]] */
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=byte[], code=null, for r16v0, types: [byte[]] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x007d A[LOOP:0: B:1:0x0009->B:27:0x007d, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x007c A[SYNTHETIC] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0088 A[LOOP:0: B:1:0x0009->B:30:0x0088, LOOP_END] */
