...
final class PlaybackInfo {
    ...
    public PlaybackInfo(Timeline timeline2, long j, TrackSelectorResult trackSelectorResult2) {
        this(timeline2, null, new MediaPeriodId(0), j, -9223372036854775807L, 1, false, trackSelectorResult2);
    }

    public PlaybackInfo(Timeline timeline2, Object obj, MediaPeriodId mediaPeriodId, long j, long j2, int i, boolean z, TrackSelectorResult trackSelectorResult2) {
    ...
    public PlaybackInfo fromNewPosition(MediaPeriodId mediaPeriodId, long j, long j2) {
        PlaybackInfo playbackInfo = new PlaybackInfo(this.timeline, this.manifest, mediaPeriodId, j, mediaPeriodId.isAd() ? j2 : -9223372036854775807L, this.playbackState, this.isLoading, this.trackSelectorResult);
        return playbackInfo;
    }
