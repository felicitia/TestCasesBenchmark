...
public final class zzk {
    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            ...
            long zza = zza(rotateRight, zzb6 + Long.rotateRight(zzb7 - 7286425919675154353L, 18) + zzb8, j4);
            byte[] bArr3 = bArr;
            long zzb9 = zzb(bArr3, 16) * j4;
            long zzb10 = zzb(bArr3, 24);
            long zzb11 = (rotateRight + zzb(bArr3, i3 - 32)) * j4;
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr3, i3 - 24)) * j4), zzb9 + Long.rotateRight(zzb10 + zzb6, 18) + zzb11, j4);
        } else {
            ...
            int i8 = 0;
            while (true) {
                long rotateRight2 = (Long.rotateRight(((zzb12 + j5) + jArr[c]) + zzb(bArr2, i8 + 8), i) * -5435081209227447693L) ^ jArr2[1];
                long rotateRight3 = (Long.rotateRight(j5 + jArr[c2] + zzb(bArr2, i8 + 48), 42) * -5435081209227447693L) + jArr[0] + zzb(bArr2, i8 + 40);
                long rotateRight4 = Long.rotateRight(j6 + jArr2[0], 33) * -5435081209227447693L;
                int i9 = i6;
                int i10 = i5;
                zza(bArr2, i8, jArr[1] * -5435081209227447693L, rotateRight2 + jArr2[0], jArr);
                zza(bArr2, i8 + 32, rotateRight4 + jArr2[1], rotateRight3 + zzb(bArr2, i8 + 16), jArr2);
                int i11 = i8 + 64;
                if (i11 == i10) {
                    ...
                    long rotateRight5 = (Long.rotateRight(((rotateRight4 + rotateRight3) + jArr[0]) + zzb(bArr2, i7 + 8), 37) * j7) ^ (jArr2[1] * 9);
                    long rotateRight6 = (Long.rotateRight(rotateRight3 + jArr[1] + zzb(bArr2, i7 + 48), 42) * j7) + (jArr[0] * 9) + zzb(bArr2, i7 + 40);
                    long rotateRight7 = Long.rotateRight(rotateRight2 + jArr2[0], 33) * j7;
                    zza(bArr2, i7, jArr[1] * j7, rotateRight5 + jArr2[0], jArr);
                    zza(bArr2, i7 + 32, rotateRight7 + jArr2[1], rotateRight6 + zzb(bArr2, i7 + 16), jArr2);
                    long j8 = j7;
