...
public class zza {
    ...
    private static final Uri zza = Uri.parse("content://com.google.android.gsf.gservices/prefix");
    private static final Pattern zzb = Pattern.compile("^(1|true|t|on|yes|y)$", 2);
    private static final Pattern zzc = Pattern.compile("^(0|false|f|off|no|n)$", 2);
    /* access modifiers changed from: private */
    public static final AtomicBoolean zzd = new AtomicBoolean();
    private static HashMap<String, String> zze;
    private static final HashMap<String, Boolean> zzf = new HashMap<>();
    private static final HashMap<String, Integer> zzg = new HashMap<>();
    private static final HashMap<String, Long> zzh = new HashMap<>();
    private static final HashMap<String, Float> zzi = new HashMap<>();
    private static Object zzj;
    private static boolean zzk;
    private static String[] zzl = new String[0];
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            java.lang.Class<com.google.android.gms.internal.firebase-perf.zza> r12 = com.google.android.gms.internal.firebase-perf.zza.class
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zze     // Catch:{ all -> 0x00f5 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = zzd     // Catch:{ all -> 0x00f5 }
            r0.set(r2)     // Catch:{ all -> 0x00f5 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zze = r0     // Catch:{ all -> 0x00f5 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzj = r0     // Catch:{ all -> 0x00f5 }
            zzk = r2     // Catch:{ all -> 0x00f5 }
            android.net.Uri r0 = CONTENT_URI     // Catch:{ all -> 0x00f5 }
            com.google.android.gms.internal.firebase-perf.zzb r4 = new com.google.android.gms.internal.firebase-perf.zzb     // Catch:{ all -> 0x00f5 }
        ...
        L_0x002a:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = zzf     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = zzg     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = zzh     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = zzi     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzj = r0     // Catch:{ all -> 0x00f5 }
            zzk = r2     // Catch:{ all -> 0x00f5 }
        L_0x0054:
            java.lang.Object r0 = zzj     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = zze     // Catch:{ all -> 0x00f5 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f5 }
            if (r4 == 0) goto L_0x006c
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zze     // Catch:{ all -> 0x00f5 }
        ...
        L_0x006a:
            ...
            return r10
        L_0x006c:
            java.lang.String[] r4 = zzl     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0070:
            ...
            boolean r0 = zzk     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x0086
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zze     // Catch:{ all -> 0x00f5 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x00a9
        L_0x0086:
            java.lang.String[] r0 = zzl     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = zze     // Catch:{ all -> 0x00f5 }
            java.util.Map r10 = zza(r10, r0)     // Catch:{ all -> 0x00f5 }
            r2.putAll(r10)     // Catch:{ all -> 0x00f5 }
            zzk = r1     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zze     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00f5:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase-perf.zza.zza(android.content.ContentResolver, java.lang.String, java.lang.String):java.lang.String");
    }
    ...
    private static Map<String, String> zza(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(zza, null, null, strArr, null);
