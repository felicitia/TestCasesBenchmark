...
public final class zzki extends zzacd<zzki> {
    ...
    public final int hashCode() {
        ...
        int i = 0;
        int hashCode2 = (hashCode * 31) + (zzkl == null ? 0 : zzkl.hashCode());
        zzkj zzkj = this.zzatr;
        int hashCode3 = ((((((((((hashCode2 * 31) + (zzkj == null ? 0 : zzkj.hashCode())) * 31) + (this.zzats == null ? 0 : this.zzats.hashCode())) * 31) + (this.zzatt == null ? 0 : this.zzatt.hashCode())) * 31) + (this.zzatu == null ? 0 : this.zzatu.hashCode())) * 31) + (this.zzatv == null ? 0 : this.zzatv.hashCode())) * 31;
    ...
    public final int zza() {
        int zza = super.zza();
        if (this.zzatq != null) {
            zza += zzacb.zzb(1, (zzacj) this.zzatq);
        }
        if (this.zzatr != null) {
            zza += zzacb.zzb(2, (zzacj) this.zzatr);
        }
        if (this.zzats != null) {
    ...
    public final void zza(zzacb zzacb) throws IOException {
        if (this.zzatq != null) {
            zzacb.zza(1, (zzacj) this.zzatq);
        }
        if (this.zzatr != null) {
            zzacb.zza(2, (zzacj) this.zzatr);
        }
        if (this.zzats != null) {
