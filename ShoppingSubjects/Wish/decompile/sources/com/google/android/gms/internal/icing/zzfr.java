...
interface zzfr {
    ...
    void zza(int i, zzbi zzbi) throws IOException;

    <K, V> void zza(int i, zzdk<K, V> zzdk, Map<K, V> map) throws IOException;
    ...
    void zzb(int i, List<zzbi> list) throws IOException;
    ...
    @Deprecated
    void zzy(int i) throws IOException;

    @Deprecated
    void zzz(int i) throws IOException;
}
