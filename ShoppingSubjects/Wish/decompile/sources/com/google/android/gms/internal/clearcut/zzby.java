...
final class zzby<FieldDescriptorType extends zzca<FieldDescriptorType>> {
    ...
    private final void zza(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (r7 instanceof zzcr) {
            this.zzgv = true;
        }
        this.zzgt.put(fielddescriptortype, r7);
    }
    ...
    private final void zzc(Entry<FieldDescriptorType, Object> entry) {
        ...
        if (zzca.zzaw()) {
            Object zza = zza((FieldDescriptorType) zzca);
            if (zza == null) {
                zza = new ArrayList();
            }
            ...
            Object zza2 = zza((FieldDescriptorType) zzca);
            if (zza2 == null) {
    ...
    private static int zzd(Entry<FieldDescriptorType, Object> entry) {
        zzca zzca = (zzca) entry.getKey();
        Object value = entry.getValue();
        return (zzca.zzav() != zzfq.MESSAGE || zzca.zzaw() || zzca.zzax()) ? zzb(zzca, value) : value instanceof zzcr ? zzbn.zzb(((zzca) entry.getKey()).zzc(), (zzcv) (zzcr) value) : zzbn.zzd(((zzca) entry.getKey()).zzc(), (zzdo) value);
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zzgt.zzdr(); i++) {
            ...
            zzby.zza((FieldDescriptorType) (zzca) zzak.getKey(), zzak.getValue());
        }
        for (Entry entry : this.zzgt.zzds()) {
            zzby.zza((FieldDescriptorType) (zzca) entry.getKey(), entry.getValue());
        }
        zzby.zzgv = this.zzgv;
        return zzby;
    }
