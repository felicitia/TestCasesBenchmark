    ...
    public final String zzh(byte[] bArr, int i, int i2) throws zzct {
        ...
        while (r13 < i3) {
            ...
            if (zzfk.zzd(b2)) {
                ...
                int i13 = i12 + 1;
                int i14 = i6 + 1;
                zzfk.zza(b2, bArr[i7], bArr[i12], cArr, i6);
                r13 = i13;
                i6 = i14;
            } else if (i7 >= i3 - 2) {
                throw zzct.zzee();
                ...
                int i17 = i16 + 1;
                int i18 = i6 + 1;
                zzfk.zza(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                r13 = i17;
                i6 = i18 + 1;
            }
        }
