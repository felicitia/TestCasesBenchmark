...
public final class zzgi extends zzhj {
    ...
    public static final AtomicLong zzanv = new AtomicLong(Long.MIN_VALUE);
    ...
    /* access modifiers changed from: private */
    public final Object zzans = new Object();
    /* access modifiers changed from: private */
    public final Semaphore zzant = new Semaphore(2);
    /* access modifiers changed from: private */
    public volatile boolean zzanu;
    ...
    public final <T> T zza(java.util.concurrent.atomic.AtomicReference<T> r1, long r2, java.lang.String r4, java.lang.Runnable r5) {
        /*
            r0 = this;
            monitor-enter(r1)
            com.google.android.gms.internal.measurement.zzgi r2 = r0.zzgh()     // Catch:{ all -> 0x005c }
            ...
            com.google.android.gms.internal.measurement.zzfi r2 = r0.zzgi()
        ...
        L_0x0036:
            return r1
        L_0x0037:
            com.google.android.gms.internal.measurement.zzfi r2 = r0.zzgi()     // Catch:{ all -> 0x005c }
            com.google.android.gms.internal.measurement.zzfk r2 = r2.zziy()     // Catch:{ all -> 0x005c }
        ...
        L_0x005c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzgi.zza(java.util.concurrent.atomic.AtomicReference, long, java.lang.String, java.lang.Runnable):java.lang.Object");
    }
    ...
    public final <V> Future<V> zzb(Callable<V> callable) throws IllegalStateException {
        ...
        zzgl zzgl = new zzgl(this, callable, false, "Task exception on worker thread");
        if (Thread.currentThread() == this.zzanm) {
    ...
    public final <V> Future<V> zzc(Callable<V> callable) throws IllegalStateException {
        zzch();
        Preconditions.checkNotNull(callable);
        zzgl zzgl = new zzgl(this, callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zzanm) {
            zzgl.run();
            return zzgl;
        }
