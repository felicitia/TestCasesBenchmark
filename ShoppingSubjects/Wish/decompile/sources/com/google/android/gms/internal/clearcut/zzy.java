...
public class zzy {
    ...
    public static long getLong(ContentResolver contentResolver, String str, long j) {
        ...
        long j2 = 0;
        Long l = (Long) zza(zzcx, str, (T) Long.valueOf(0));
        if (l != null) {
            return l.longValue();
        }
    ...
    public static java.lang.String zza(android.content.ContentResolver r13, java.lang.String r14, java.lang.String r15) {
        /*
            ...
            java.lang.Object r0 = zzcz     // Catch:{ all -> 0x00a6 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzcu     // Catch:{ all -> 0x00a6 }
            boolean r1 = r1.containsKey(r14)     // Catch:{ all -> 0x00a6 }
            r2 = 0
            if (r1 == 0) goto L_0x001f
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzcu     // Catch:{ all -> 0x00a6 }
        ...
        L_0x001d:
            ...
            return r13
        L_0x001f:
            java.lang.String[] r1 = zzdb     // Catch:{ all -> 0x00a6 }
        ...
        L_0x0024:
            ...
            boolean r0 = zzda     // Catch:{ all -> 0x00a6 }
            if (r0 == 0) goto L_0x003b
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzcu     // Catch:{ all -> 0x00a6 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00a6 }
            if (r0 == 0) goto L_0x005e
        L_0x003b:
            java.lang.String[] r0 = zzdb     // Catch:{ all -> 0x00a6 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzcu     // Catch:{ all -> 0x00a6 }
    ...
    public static boolean zza(ContentResolver contentResolver, String str, boolean z) {
        Object zzb = zzb(contentResolver);
        Boolean bool = (Boolean) zza(zzcv, str, (T) Boolean.valueOf(z));
        if (bool != null) {
